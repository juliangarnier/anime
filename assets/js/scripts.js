...
void main() {
...
}`,Tm=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t,n){if(this.texture===null){let s=new zt,r=e.properties.get(s);r.__webglTexture=t.texture,(t.depthNear!==n.depthNear||t.depthFar!==n.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=s}}getMesh(e){if(this.texture!==null&&this.mesh===null){let t=e.cameras[0].viewport,n=new Nt({vertexShader:vS,fragmentShader:xS,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new Qt(new ia(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},Mm=class extends Ln{constructor(e,t){super();let n=this,s=null,r=1,a=null,o="local-floor",l=1,c=null,h=null,u=null,d=null,p=null,g=null,v=new Tm,m=t.getContextAttributes(),f=null,x=null,A=[],y=[],T=new Pe,M=null,C=new qt;C.viewport=new yt;let R=new qt;R.viewport=new yt;let b=[C,R],S=new uu,D=null,U=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(W){let j=A[W];return j===void 0&&(j=new yc,A[W]=j),j.getTargetRaySpace()},this.getControllerGrip=function(W){let j=A[W];return j===void 0&&(j=new yc,A[W]=j),j.getGripSpace()},this.getHand=function(W){let j=A[W];return j===void 0&&(j=new yc,A[W]=j),j.getHandSpace()};function O(W){let j=y.indexOf(W.inputSource);if(j===-1)return;let ie=A[j];ie!==void 0&&(ie.update(W.inputSource,W.frame,c||a),ie.dispatchEvent({type:W.type,data:W.inputSource}))}function N(){s.removeEventListener("select",O),s.removeEventListener("selectstart",O),s.removeEventListener("selectend",O),s.removeEventListener("squeeze",O),s.removeEventListener("squeezestart",O),s.removeEventListener("squeezeend",O),s.removeEventListener("end",N),s.removeEventListener("inputsourceschange",V);for(let W=0;W<A.length;W++){let j=y[W];j!==null&&(y[W]=null,A[W].disconnect(j))}D=null,U=null,v.reset(),e.setRenderTarget(f),p=null,d=null,u=null,s=null,x=null,le.stop(),n.isPresenting=!1,e.setPixelRatio(M),e.setSize(T.width,T.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(W){r=W,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(W){o=W,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(W){c=W},this.getBaseLayer=function(){return d!==null?d:p},this.getBinding=function(){return u},this.getFrame=function(){return g},this.getSession=function(){return s},this.setSession=async function(W){if(s=W,s!==null){if(f=e.getRenderTarget(),s.addEventListener("select",O),s.addEventListener("selectstart",O),s.addEventListener("selectend",O),s.addEventListener("squeeze",O),s.addEventListener("squeezestart",O),s.addEventListener("squeezeend",O),s.addEventListener("end",N),s.addEventListener("inputsourceschange",V),m.xrCompatible!==!0&&await t.makeXRCompatible(),M=e.getPixelRatio(),e.getSize(T),s.enabledFeatures!==void 0&&s.enabledFeatures.includes("layers")){let ie=null,ue=null,Ie=null;m.depth&&(Ie=m.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,ie=m.stencil?Wi:$s,ue=m.stencil?Vi:Fi);let De={colorFormat:t.RGBA8,depthFormat:Ie,scaleFactor:r};u=new XRWebGLBinding(s,t),d=u.createProjectionLayer(De),s.updateRenderState({layers:[d]}),e.setPixelRatio(1),e.setSize(d.textureWidth,d.textureHeight,!1),x=new Ht(d.textureWidth,d.textureHeight,{format:Vn,type:kt,depthTexture:new ta(d.textureWidth,d.textureHeight,ue,void 0,void 0,void 0,void 0,void 0,void 0,ie),stencilBuffer:m.stencil,colorSpace:e.outputColorSpace,samples:m.antialias?4:0,resolveDepthBuffer:d.ignoreDepthValues===!1})}else{let ie={antialias:m.antialias,alpha:!0,depth:m.depth,stencil:m.stencil,framebufferScaleFactor:r};p=new XRWebGLLayer(s,t,ie),s.updateRenderState({baseLayer:p}),e.setPixelRatio(1),e.setSize(p.framebufferWidth,p.framebufferHeight,!1),x=new Ht(p.framebufferWidth,p.framebufferHeight,{format:Vn,type:kt,colorSpace:e.outputColorSpace,stencilBuffer:m.stencil})}x.isXRRenderTarget=!0,this.setFoveation(l),c=null,a=await s.requestReferenceSpace(o),le.setContext(s),le.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(s!==null)return s.environmentBlendMode},this.getDepthTexture=function(){return v.getDepthTexture()};function V(W){for(let j=0;j<W.removed.length;j++){let ie=W.removed[j],ue=y.indexOf(ie);ue>=0&&(y[ue]=null,A[ue].disconnect(ie))}for(let j=0;j<W.added.length;j++){let ie=W.added[j],ue=y.indexOf(ie);if(ue===-1){for(let De=0;De<A.length;De++)if(De>=y.length){y.push(ie),ue=De;break}else if(y[De]===null){y[De]=ie,ue=De;break}if(ue===-1)break}let Ie=A[ue];Ie&&Ie.connect(ie)}}let B=new k,I=new k;function P(W,j,ie){B.setFromMatrixPosition(j.matrixWorld),I.setFromMatrixPosition(ie.matrixWorld);let ue=B.distanceTo(I),Ie=j.projectionMatrix.elements,De=ie.projectionMatrix.elements,He=Ie[14]/(Ie[10]-1),$e=Ie[14]/(Ie[10]+1),We=(Ie[9]+1)/Ie[5],Je=(Ie[9]-1)/Ie[5],F=(Ie[8]-1)/Ie[0],Dt=(De[8]+1)/De[0],Be=He*F,qe=He*Dt,Le=ue/(-F+Dt),pe=Le*-F;if(j.matrixWorld.decompose(W.position,W.quaternion,W.scale),W.translateX(pe),W.translateZ(Le),W.matrixWorld.compose(W.position,W.quaternion,W.scale),W.matrixWorldInverse.copy(W.matrixWorld).invert(),Ie[10]===-1)W.projectionMatrix.copy(j.projectionMatrix),W.projectionMatrixInverse.copy(j.projectionMatrixInverse);else{let xe=He+Le,w=$e+Le,_=Be-pe,Y=qe+(ue-pe),$=We*$e/w*xe,se=Je*$e/w*xe;W.projectionMatrix.makePerspective(_,Y,$,se,xe,w),W.projectionMatrixInverse.copy(W.projectionMatrix).invert()}}function L(W,j){j===null?W.matrixWorld.copy(W.matrix):W.matrixWorld.multiplyMatrices(j.matrixWorld,W.matrix),W.matrixWorldInverse.copy(W.matrixWorld).invert()}this.updateCamera=function(W){if(s===null)return;let j=W.near,ie=W.far;v.texture!==null&&(v.depthNear>0&&(j=v.depthNear),v.depthFar>0&&(ie=v.depthFar)),S.near=R.near=C.near=j,S.far=R.far=C.far=ie,(D!==S.near||U!==S.far)&&(s.updateRenderState({depthNear:S.near,depthFar:S.far}),D=S.near,U=S.far),C.layers.mask=W.layers.mask|2,R.layers.mask=W.layers.mask|4,S.layers.mask=C.layers.mask|R.layers.mask;let ue=W.parent,Ie=S.cameras;L(S,ue);for(let De=0;De<Ie.length;De++)L(Ie[De],ue);Ie.length===2?P(S,C,R):S.projectionMatrix.copy(C.projectionMatrix),J(W,S,ue)};function J(W,j,ie){ie===null?W.matrix.copy(j.matrixWorld):(W.matrix.copy(ie.matrixWorld),W.matrix.invert(),W.matrix.multiply(j.matrixWorld)),W.matrix.decompose(W.position,W.quaternion,W.scale),W.updateMatrixWorld(!0),W.projectionMatrix.copy(j.projectionMatrix),W.projectionMatrixInverse.copy(j.projectionMatrixInverse),W.isPerspectiveCamera&&(W.fov=ir*2*Math.atan(1/W.projectionMatrix.elements[5]),W.zoom=1)}this.getCamera=function(){return S},this.getFoveation=function(){if(!(d===null&&p===null))return l},this.setFoveation=function(W){l=W,d!==null&&(d.fixedFoveation=W),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=W)},this.hasDepthSensing=function(){return v.texture!==null},this.getDepthSensingMesh=function(){return v.getMesh(S)};let ae=null;function ve(W,j){if(h=j.getViewerPose(c||a),g=j,h!==null){let ie=h.views;p!==null&&(e.setRenderTargetFramebuffer(x,p.framebuffer),e.setRenderTarget(x));let ue=!1;ie.length!==S.cameras.length&&(S.cameras.length=0,ue=!0);for(let De=0;De<ie.length;De++){let He=ie[De],$e=null;if(p!==null)$e=p.getViewport(He);else{let Je=u.getViewSubImage(d,He);$e=Je.viewport,De===0&&(e.setRenderTargetTextures(x,Je.colorTexture,d.ignoreDepthValues?void 0:Je.depthStencilTexture),e.setRenderTarget(x))}let We=b[De];We===void 0&&(We=new qt,We.layers.enable(De),We.viewport=new yt,b[De]=We),We.matrix.fromArray(He.transform.matrix),We.matrix.decompose(We.position,We.quaternion,We.scale),We.projectionMatrix.fromArray(He.projectionMatrix),We.projectionMatrixInverse.copy(We.projectionMatrix).invert(),We.viewport.set($e.x,$e.y,$e.width,$e.height),De===0&&(S.matrix.copy(We.matrix),S.matrix.decompose(S.position,S.quaternion,S.scale)),ue===!0&&S.cameras.push(We)}let Ie=s.enabledFeatures;if(Ie&&Ie.includes("depth-sensing")){let De=u.getDepthInformation(ie[0]);De&&De.isValid&&De.texture&&v.init(e,De,s.renderState)}}for(let ie=0;ie<A.length;ie++){let ue=y[ie],Ie=A[ie];ue!==null&&Ie!==void 0&&Ie.update(ue,j,c||a)}ae&&ae(W,j),j.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:j}),g=null}let le=new Yp;le.setAnimationLoop(ve),this.setAnimationLoop=function(W){ae=W},this.dispose=function(){}}},vr=new ri,yS=new Ze;function AS(i,e){function t(m,f){m.matrixAutoUpdate===!0&&m.updateMatrix(),f.value.copy(m.matrix)}function n(m,f){f.color.getRGB(m.fogColor.value,qh(i)),f.isFog?(m.fogNear.value=f.near,m.fogFar.value=f.far):f.isFogExp2&&(m.fogDensity.value=f.density)}function s(m,f,x,A,y){f.isMeshBasicMaterial||f.isMeshLambertMaterial?r(m,f):f.isMeshToonMaterial?(r(m,f),u(m,f)):f.isMeshPhongMaterial?(r(m,f),h(m,f)):f.isMeshStandardMaterial?(r(m,f),d(m,f),f.isMeshPhysicalMaterial&&p(m,f,y)):f.isMeshMatcapMaterial?(r(m,f),g(m,f)):f.isMeshDepthMaterial?r(m,f):f.isMeshDistanceMaterial?(r(m,f),v(m,f)):f.isMeshNormalMaterial?r(m,f):f.isLineBasicMaterial?(a(m,f),f.isLineDashedMaterial&&o(m,f)):f.isPointsMaterial?l(m,f,x,A):f.isSpriteMaterial?c(m,f):f.isShadowMaterial?(m.color.value.copy(f.color),m.opacity.value=f.opacity):f.isShaderMaterial&&(f.uniformsNeedUpdate=!1)}function r(m,f){m.opacity.value=f.opacity,f.color&&m.diffuse.value.copy(f.color),f.emissive&&m.emissive.value.copy(f.emissive).multiplyScalar(f.emissiveIntensity),f.map&&(m.map.value=f.map,t(f.map,m.mapTransform)),f.alphaMap&&(m.alphaMap.value=f.alphaMap,t(f.alphaMap,m.alphaMapTransform)),f.bumpMap&&(m.bumpMap.value=f.bumpMap,t(f.bumpMap,m.bumpMapTransform),m.bumpScale.value=f.bumpScale,f.side===an&&(m.bumpScale.value*=-1)),f.normalMap&&(m.normalMap.value=f.normalMap,t(f.normalMap,m.normalMapTransform),m.normalScale.value.copy(f.normalScale),f.side===an&&m.normalScale.value.negate()),f.displacementMap&&(m.displacementMap.value=f.displacementMap,t(f.displacementMap,m.displacementMapTransform),m.displacementScale.value=f.displacementScale,m.displacementBias.value=f.displacementBias),f.emissiveMap&&(m.emissiveMap.value=f.emissiveMap,t(f.emissiveMap,m.emissiveMapTransform)),f.specularMap&&(m.specularMap.value=f.specularMap,t(f.specularMap,m.specularMapTransform)),f.alphaTest>0&&(m.alphaTest.value=f.alphaTest);let x=e.get(f),A=x.envMap,y=x.envMapRotation;A&&(m.envMap.value=A,vr.copy(y),vr.x*=-1,vr.y*=-1,vr.z*=-1,A.isCubeTexture&&A.isRenderTargetTexture===!1&&(vr.y*=-1,vr.z*=-1),m.envMapRotation.value.setFromMatrix4(yS.makeRotationFromEuler(vr)),m.flipEnvMap.value=A.isCubeTexture&&A.isRenderTargetTexture===!1?-1:1,m.reflectivity.value=f.reflectivity,m.ior.value=f.ior,m.refractionRatio.value=f.refractionRatio),f.lightMap&&(m.lightMap.value=f.lightMap,m.lightMapIntensity.value=f.lightMapIntensity,t(f.lightMap,m.lightMapTransform)),f.aoMap&&(m.aoMap.value=f.aoMap,m.aoMapIntensity.value=f.aoMapIntensity,t(f.aoMap,m.aoMapTransform))}function a(m,f){m.diffuse.value.copy(f.color),m.opacity.value=f.opacity,f.map&&(m.map.value=f.map,t(f.map,m.mapTransform))}function o(m,f){m.dashSize.value=f.dashSize,m.totalSize.value=f.dashSize+f.gapSize,m.scale.value=f.scale}function l(m,f,x,A){m.diffuse.value.copy(f.color),m.opacity.value=f.opacity,m.size.value=f.size*x,m.scale.value=A*.5,f.map&&(m.map.value=f.map,t(f.map,m.uvTransform)),f.alphaMap&&(m.alphaMap.value=f.alphaMap,t(f.alphaMap,m.alphaMapTransform)),f.alphaTest>0&&(m.alphaTest.value=f.alphaTest)}function c(m,f){m.diffuse.value.copy(f.color),m.opacity.value=f.opacity,m.rotation.value=f.rotation,f.map&&(m.map.value=f.map,t(f.map,m.mapTransform)),f.alphaMap&&(m.alphaMap.value=f.alphaMap,t(f.alphaMap,m.alphaMapTransform)),f.alphaTest>0&&(m.alphaTest.value=f.alphaTest)}function h(m,f){m.specular.value.copy(f.specular),m.shininess.value=Math.max(f.shininess,1e-4)}function u(m,f){f.gradientMap&&(m.gradientMap.value=f.gradientMap)}function d(m,f){m.metalness.value=f.metalness,f.metalnessMap&&(m.metalnessMap.value=f.metalnessMap,t(f.metalnessMap,m.metalnessMapTransform)),m.roughness.value=f.roughness,f.roughnessMap&&(m.roughnessMap.value=f.roughnessMap,t(f.roughnessMap,m.roughnessMapTransform)),f.envMap&&(m.envMapIntensity.value=f.envMapIntensity)}function p(m,f,x){m.ior.value=f.ior,f.sheen>0&&(m.sheenColor.value.copy(f.sheenColor).multiplyScalar(f.sheen),m.sheenRoughness.value=f.sheenRoughness,f.sheenColorMap&&(m.sheenColorMap.value=f.sheenColorMap,t(f.sheenColorMap,m.sheenColorMapTransform)),f.sheenRoughnessMap&&(m.sheenRoughnessMap.value=f.sheenRoughnessMap,t(f.sheenRoughnessMap,m.sheenRoughnessMapTransform))),f.clearcoat>0&&(m.clearcoat.value=f.clearcoat,m.clearcoatRoughness.value=f.clearcoatRoughness,f.clearcoatMap&&(m.clearcoatMap.value=f.clearcoatMap,t(f.clearcoatMap,m.clearcoatMapTransform)),f.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=f.clearcoatRoughnessMap,t(f.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),f.clearcoatNormalMap&&(m.clearcoatNormalMap.value=f.clearcoatNormalMap,t(f.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(f.clearcoatNormalScale),f.side===an&&m.clearcoatNormalScale.value.negate())),f.dispersion>0&&(m.dispersion.value=f.dispersion),f.iridescence>0&&(m.iridescence.value=f.iridescence,m.iridescenceIOR.value=f.iridescenceIOR,m.iridescenceThicknessMinimum.value=f.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=f.iridescenceThicknessRange[1],f.iridescenceMap&&(m.iridescenceMap.value=f.iridescenceMap,t(f.iridescenceMap,m.iridescenceMapTransform)),f.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=f.iridescenceThicknessMap,t(f.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),f.transmission>0&&(m.transmission.value=f.transmission,m.transmissionSamplerMap.value=x.texture,m.transmissionSamplerSize.value.set(x.width,x.height),f.transmissionMap&&(m.transmissionMap.value=f.transmissionMap,t(f.transmissionMap,m.transmissionMapTransform)),m.thickness.value=f.thickness,f.thicknessMap&&(m.thicknessMap.value=f.thicknessMap,t(f.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=f.attenuationDistance,m.attenuationColor.value.copy(f.attenuationColor)),f.anisotropy>0&&(m.anisotropyVector.value.set(f.anisotropy*Math.cos(f.anisotropyRotation),f.anisotropy*Math.sin(f.anisotropyRotation)),f.anisotropyMap&&(m.anisotropyMap.value=f.anisotropyMap,t(f.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=f.specularIntensity,m.specularColor.value.copy(f.specularColor),f.specularColorMap&&(m.specularColorMap.value=f.specularColorMap,t(f.specularColorMap,m.specularColorMapTransform)),f.specularIntensityMap&&(m.specularIntensityMap.value=f.specularIntensityMap,t(f.specularIntensityMap,m.specularIntensityMapTransform))}function g(m,f){f.matcap&&(m.matcap.value=f.matcap)}function v(m,f){let x=e.get(f).light;m.referencePosition.value.setFromMatrixPosition(x.matrixWorld),m.nearDistance.value=x.shadow.camera.near,m.farDistance.value=x.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:s}}function _S(i,e,t,n){let s={},r={},a=[],o=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function l(x,A){let y=A.program;n.uniformBlockBinding(x,y)}function c(x,A){let y=s[x.id];y===void 0&&(g(x),y=h(x),s[x.id]=y,x.addEventListener("dispose",m));let T=A.program;n.updateUBOMapping(x,T);let M=e.render.frame;r[x.id]!==M&&(d(x),r[x.id]=M)}function h(x){let A=u();x.__bindingPointIndex=A;let y=i.createBuffer(),T=x.__size,M=x.usage;return i.bindBuffer(i.UNIFORM_BUFFER,y),i.bufferData(i.UNIFORM_BUFFER,T,M),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,A,y),y}function u(){for(let x=0;x<o;x++)if(a.indexOf(x)===-1)return a.push(x),x;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function d(x){let A=s[x.id],y=x.uniforms,T=x.__cache;i.bindBuffer(i.UNIFORM_BUFFER,A);for(let M=0,C=y.length;M<C;M++){let R=Array.isArray(y[M])?y[M]:[y[M]];for(let b=0,S=R.length;b<S;b++){let D=R[b];if(p(D,M,b,T)===!0){let U=D.__offset,O=Array.isArray(D.value)?D.value:[D.value],N=0;for(let V=0;V<O.length;V++){let B=O[V],I=v(B);typeof B=="number"||typeof B=="boolean"?(D.__data[0]=B,i.bufferSubData(i.UNIFORM_BUFFER,U+N,D.__data)):B.isMatrix3?(D.__data[0]=B.elements[0],D.__data[1]=B.elements[1],D.__data[2]=B.elements[2],D.__data[3]=0,D.__data[4]=B.elements[3],D.__data[5]=B.elements[4],D.__data[6]=B.elements[5],D.__data[7]=0,D.__data[8]=B.elements[6],D.__data[9]=B.elements[7],D.__data[10]=B.elements[8],D.__data[11]=0):(B.toArray(D.__data,N),N+=I.storage/Float32Array.BYTES_PER_ELEMENT)}i.bufferSubData(i.UNIFORM_BUFFER,U,D.__data)}}}i.bindBuffer(i.UNIFORM_BUFFER,null)}function p(x,A,y,T){let M=x.value,C=A+"_"+y;if(T[C]===void 0)return typeof M=="number"||typeof M=="boolean"?T[C]=M:T[C]=M.clone(),!0;{let R=T[C];if(typeof M=="number"||typeof M=="boolean"){if(R!==M)return T[C]=M,!0}else if(R.equals(M)===!1)return R.copy(M),!0}return!1}function g(x){let A=x.uniforms,y=0,T=16;for(let C=0,R=A.length;C<R;C++){let b=Array.isArray(A[C])?A[C]:[A[C]];for(let S=0,D=b.length;S<D;S++){let U=b[S],O=Array.isArray(U.value)?U.value:[U.value];for(let N=0,V=O.length;N<V;N++){let B=O[N],I=v(B),P=y%T,L=P%I.boundary,J=P+L;y+=L,J!==0&&T-J<I.storage&&(y+=T-J),U.__data=new Float32Array(I.storage/Float32Array.BYTES_PER_ELEMENT),U.__offset=y,y+=I.storage}}}let M=y%T;return M>0&&(y+=T-M),x.__size=y,x.__cache={},this}function v(x){let A={boundary:0,storage:0};return typeof x=="number"||typeof x=="boolean"?(A.boundary=4,A.storage=4):x.isVector2?(A.boundary=8,A.storage=8):x.isVector3||x.isColor?(A.boundary=16,A.storage=12):x.isVector4?(A.boundary=16,A.storage=16):x.isMatrix3?(A.boundary=48,A.storage=48):x.isMatrix4?(A.boundary=64,A.storage=64):x.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",x),A}function m(x){let A=x.target;A.removeEventListener("dispose",m);let y=a.indexOf(A.__bindingPointIndex);a.splice(y,1),i.deleteBuffer(s[A.id]),delete s[A.id],delete r[A.id]}function f(){for(let x in s)i.deleteBuffer(s[x]);a=[],s={},r={}}return{bind:l,update:c,dispose:f}}var no=class{constructor(e={}){let{canvas:t=qf(),context:n=null,depth:s=!0,stencil:r=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:h="default",failIfMajorPerformanceCaveat:u=!1,reverseDepthBuffer:d=!1}=e;this.isWebGLRenderer=!0;let p;if(n!==null){if(typeof WebGLRenderingContext!="undefined"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");p=n.getContextAttributes().alpha}else p=a;let g=new Uint32Array(4),v=new Int32Array(4),m=null,f=null,x=[],A=[];this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=nt,this.toneMapping=Gi,this.toneMappingExposure=1;let y=this,T=!1,M=0,C=0,R=null,b=-1,S=null,D=new yt,U=new yt,O=null,N=new Ae(0),V=0,B=t.width,I=t.height,P=1,L=null,J=null,ae=new yt(0,0,B,I),ve=new yt(0,0,B,I),le=!1,W=new ja,j=!1,ie=!1;this.transmissionResolutionScale=1;let ue=new Ze,Ie=new Ze,De=new k,He=new yt,$e={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},We=!1;function Je(){return R===null?P:1}let F=n;function Dt(E,H){return t.getContext(E,H)}try{let E={alpha:!0,depth:s,stencil:r,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:h,failIfMajorPerformanceCaveat:u};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${Pi}`),t.addEventListener("webglcontextlost",he,!1),t.addEventListener("webglcontextrestored",Me,!1),t.addEventListener("webglcontextcreationerror",be,!1),F===null){let H="webgl2";if(F=Dt(H,E),F===null)throw Dt(H)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(E){throw console.error("THREE.WebGLRenderer: "+E.message),E}let Be,qe,Le,pe,xe,w,_,Y,$,se,te,Z,K,oe,Te,re,ge,Fe,Qe,we,Ue,Ge,Pt,z;function ce(){Be=new O_(F),Be.init(),Ge=new mS(F,Be),qe=new I_(F,Be,e,Ge),Le=new fS(F,Be),qe.reverseDepthBuffer&&d&&Le.buffers.depth.setReversed(!0),pe=new H_(F),xe=new eS,w=new pS(F,Be,Le,xe,qe,Ge,pe),_=new F_(y),Y=new B_(y),$=new qx(F),Pt=new D_(F,$),se=new k_(F,$,pe,Pt),te=new V_(F,se,$,pe),Qe=new G_(F,qe,w),re=new L_(xe),Z=new $1(y,_,Y,Be,qe,Pt,re),K=new AS(y,xe),oe=new nS,Te=new lS(Be),Fe=new R_(y,_,Y,Le,te,p,l),ge=new uS(y,te,qe),z=new _S(F,pe,qe,Le),we=new P_(F,Be,pe),Ue=new z_(F,Be,pe),pe.programs=Z.programs,y.capabilities=qe,y.extensions=Be,y.properties=xe,y.renderLists=oe,y.shadowMap=ge,y.state=Le,y.info=pe}ce();let ee=new Mm(y,F);this.xr=ee,this.getContext=function(){return F},this.getContextAttributes=function(){return F.getContextAttributes()},this.forceContextLoss=function(){let E=Be.get("WEBGL_lose_context");E&&E.loseContext()},this.forceContextRestore=function(){let E=Be.get("WEBGL_lose_context");E&&E.restoreContext()},this.getPixelRatio=function(){return P},this.setPixelRatio=function(E){E!==void 0&&(P=E,this.setSize(B,I,!1))},this.getSize=function(E){return E.set(B,I)},this.setSize=function(E,H,Q=!0){if(ee.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}B=E,I=H,t.width=Math.floor(E*P),t.height=Math.floor(H*P),Q===!0&&(t.style.width=E+"px",t.style.height=H+"px"),this.setViewport(0,0,E,H)},this.getDrawingBufferSize=function(E){return E.set(B*P,I*P).floor()},this.setDrawingBufferSize=function(E,H,Q){B=E,I=H,P=Q,t.width=Math.floor(E*Q),t.height=Math.floor(H*Q),this.setViewport(0,0,E,H)},this.getCurrentViewport=function(E){return E.copy(D)},this.getViewport=function(E){return E.copy(ae)},this.setViewport=function(E,H,Q,q){E.isVector4?ae.set(E.x,E.y,E.z,E.w):ae.set(E,H,Q,q),Le.viewport(D.copy(ae).multiplyScalar(P).round())},this.getScissor=function(E){return E.copy(ve)},this.setScissor=function(E,H,Q,q){E.isVector4?ve.set(E.x,E.y,E.z,E.w):ve.set(E,H,Q,q),Le.scissor(U.copy(ve).multiplyScalar(P).round())},this.getScissorTest=function(){return le},this.setScissorTest=function(E){Le.setScissorTest(le=E)},this.setOpaqueSort=function(E){L=E},this.setTransparentSort=function(E){J=E},this.getClearColor=function(E){return E.copy(Fe.getClearColor())},this.setClearColor=function(){Fe.setClearColor.apply(Fe,arguments)},this.getClearAlpha=function(){return Fe.getClearAlpha()},this.setClearAlpha=function(){Fe.setClearAlpha.apply(Fe,arguments)},this.clear=function(E=!0,H=!0,Q=!0){let q=0;if(E){let X=!1;if(R!==null){let de=R.texture.format;X=de===Go||de===Ho||de===zo}if(X){let de=R.texture.type,ye=de===kt||de===Fi||de===Ur||de===Vi||de===Bo||de===Oo,Ce=Fe.getClearColor(),Ee=Fe.getClearAlpha(),tt=Ce.r,it=Ce.g,Ye=Ce.b;ye?(g[0]=tt,g[1]=it,g[2]=Ye,g[3]=Ee,F.clearBufferuiv(F.COLOR,0,g)):(v[0]=tt,v[1]=it,v[2]=Ye,v[3]=Ee,F.clearBufferiv(F.COLOR,0,v))}else q|=F.COLOR_BUFFER_BIT}H&&(q|=F.DEPTH_BUFFER_BIT),Q&&(q|=F.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),F.clear(q)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",he,!1),t.removeEventListener("webglcontextrestored",Me,!1),t.removeEventListener("webglcontextcreationerror",be,!1),Fe.dispose(),oe.dispose(),Te.dispose(),xe.dispose(),_.dispose(),Y.dispose(),te.dispose(),Pt.dispose(),z.dispose(),Z.dispose(),ee.dispose(),ee.removeEventListener("sessionstart",Pn),ee.removeEventListener("sessionend",vs),Di.stop()};function he(E){E.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),T=!0}function Me(){console.log("THREE.WebGLRenderer: Context Restored."),T=!1;let E=pe.autoReset,H=ge.enabled,Q=ge.autoUpdate,q=ge.needsUpdate,X=ge.type;ce(),pe.autoReset=E,ge.enabled=H,ge.autoUpdate=Q,ge.needsUpdate=q,ge.type=X}function be(E){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",E.statusMessage)}function et(E){let H=E.target;H.removeEventListener("dispose",et),Bt(H)}function Bt(E){dn(E),xe.remove(E)}function dn(E){let H=xe.get(E).programs;H!==void 0&&(H.forEach(function(Q){Z.releaseProgram(Q)}),E.isShaderMaterial&&Z.releaseShaderCache(E))}this.renderBufferDirect=function(E,H,Q,q,X,de){H===null&&(H=$e);let ye=X.isMesh&&X.matrixWorld.determinant()<0,Ce=Et(E,H,Q,q,X);Le.setMaterial(q,ye);let Ee=Q.index,tt=1;if(q.wireframe===!0){if(Ee=se.getWireframeAttribute(Q),Ee===void 0)return;tt=2}let it=Q.drawRange,Ye=Q.attributes.position,xt=it.start*tt,_t=(it.start+it.count)*tt;de!==null&&(xt=Math.max(xt,de.start*tt),_t=Math.min(_t,(de.start+de.count)*tt)),Ee!==null?(xt=Math.max(xt,0),_t=Math.min(_t,Ee.count)):Ye!=null&&(xt=Math.max(xt,0),_t=Math.min(_t,Ye.count));let ke=_t-xt;if(ke<0||ke===1/0)return;Pt.setup(X,q,Ce,Q,Ee);let ht,dt=we;if(Ee!==null&&(ht=$.get(Ee),dt=Ue,dt.setIndex(ht)),X.isMesh)q.wireframe===!0?(Le.setLineWidth(q.wireframeLinewidth*Je()),dt.setMode(F.LINES)):dt.setMode(F.TRIANGLES);else if(X.isLine){let je=q.linewidth;je===void 0&&(je=1),Le.setLineWidth(je*Je()),X.isLineSegments?dt.setMode(F.LINES):X.isLineLoop?dt.setMode(F.LINE_LOOP):dt.setMode(F.LINE_STRIP)}else X.isPoints?dt.setMode(F.POINTS):X.isSprite&&dt.setMode(F.TRIANGLES);if(X.isBatchedMesh)if(X._multiDrawInstances!==null)dt.renderMultiDrawInstances(X._multiDrawStarts,X._multiDrawCounts,X._multiDrawCount,X._multiDrawInstances);else if(Be.get("WEBGL_multi_draw"))dt.renderMultiDraw(X._multiDrawStarts,X._multiDrawCounts,X._multiDrawCount);else{let je=X._multiDrawStarts,gn=X._multiDrawCounts,It=X._multiDrawCount,mi=Ee?$.get(Ee).bytesPerElement:1,Ir=xe.get(q).currentProgram.getUniforms();for(let zn=0;zn<It;zn++)Ir.setValue(F,"_gl_DrawID",zn),dt.render(je[zn]/mi,gn[zn])}else if(X.isInstancedMesh)dt.renderInstances(xt,ke,X.count);else if(Q.isInstancedBufferGeometry){let je=Q._maxInstanceCount!==void 0?Q._maxInstanceCount:1/0,gn=Math.min(Q.instanceCount,je);dt.renderInstances(xt,ke,gn)}else dt.render(xt,ke)};function bt(E,H,Q){E.transparent===!0&&E.side===vn&&E.forceSinglePass===!1?(E.side=an,E.needsUpdate=!0,ne(E,H,Q),E.side=Hn,E.needsUpdate=!0,ne(E,H,Q),E.side=vn):ne(E,H,Q)}this.compile=function(E,H,Q=null){Q===null&&(Q=E),f=Te.get(Q),f.init(H),A.push(f),Q.traverseVisible(function(X){X.isLight&&X.layers.test(H.layers)&&(f.pushLight(X),X.castShadow&&f.pushShadow(X))}),E!==Q&&E.traverseVisible(function(X){X.isLight&&X.layers.test(H.layers)&&(f.pushLight(X),X.castShadow&&f.pushShadow(X))}),f.setupLights();let q=new Set;return E.traverse(function(X){if(!(X.isMesh||X.isPoints||X.isLine||X.isSprite))return;let de=X.material;if(de)if(Array.isArray(de))for(let ye=0;ye<de.length;ye++){let Ce=de[ye];bt(Ce,Q,X),q.add(Ce)}else bt(de,Q,X),q.add(de)}),A.pop(),f=null,q},this.compileAsync=function(E,H,Q=null){let q=this.compile(E,H,Q);return new Promise(X=>{function de(){if(q.forEach(function(ye){xe.get(ye).currentProgram.isReady()&&q.delete(ye)}),q.size===0){X(E);return}setTimeout(de,10)}Be.get("KHR_parallel_shader_compile")!==null?de():setTimeout(de,10)})};let En=null;function Tn(E){En&&En(E)}function Pn(){Di.stop()}function vs(){Di.start()}let Di=new Yp;Di.setAnimationLoop(Tn),typeof self!="undefined"&&Di.setContext(self),this.setAnimationLoop=function(E){En=E,ee.setAnimationLoop(E),E===null?Di.stop():Di.start()},ee.addEventListener("sessionstart",Pn),ee.addEventListener("sessionend",vs),this.render=function(E,H){if(H!==void 0&&H.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(T===!0)return;if(E.matrixWorldAutoUpdate===!0&&E.updateMatrixWorld(),H.parent===null&&H.matrixWorldAutoUpdate===!0&&H.updateMatrixWorld(),ee.enabled===!0&&ee.isPresenting===!0&&(ee.cameraAutoUpdate===!0&&ee.updateCamera(H),H=ee.getCamera()),E.isScene===!0&&E.onBeforeRender(y,E,H,R),f=Te.get(E,A.length),f.init(H),A.push(f),Ie.multiplyMatrices(H.projectionMatrix,H.matrixWorldInverse),W.setFromProjectionMatrix(Ie),ie=this.localClippingEnabled,j=re.init(this.clippingPlanes,ie),m=oe.get(E,x.length),m.init(),x.push(m),ee.enabled===!0&&ee.isPresenting===!0){let de=y.xr.getDepthSensingMesh();de!==null&&Ws(de,H,-1/0,y.sortObjects)}Ws(E,H,0,y.sortObjects),m.finish(),y.sortObjects===!0&&m.sort(L,J),We=ee.enabled===!1||ee.isPresenting===!1||ee.hasDepthSensing()===!1,We&&Fe.addToRenderList(m,E),this.info.render.frame++,j===!0&&re.beginShadows();let Q=f.state.shadowsArray;ge.render(Q,E,H),j===!0&&re.endShadows(),this.info.autoReset===!0&&this.info.reset();let q=m.opaque,X=m.transmissive;if(f.setupLights(),H.isArrayCamera){let de=H.cameras;if(X.length>0)for(let ye=0,Ce=de.length;ye<Ce;ye++){let Ee=de[ye];wa(q,X,E,Ee)}We&&Fe.render(E);for(let ye=0,Ce=de.length;ye<Ce;ye++){let Ee=de[ye];Xs(m,E,Ee,Ee.viewport)}}else X.length>0&&wa(q,X,E,H),We&&Fe.render(E),Xs(m,E,H);R!==null&&C===0&&(w.updateMultisampleRenderTarget(R),w.updateRenderTargetMipmap(R)),E.isScene===!0&&E.onAfterRender(y,E,H),Pt.resetDefaultState(),b=-1,S=null,A.pop(),A.length>0?(f=A[A.length-1],j===!0&&re.setGlobalState(y.clippingPlanes,f.state.camera)):f=null,x.pop(),x.length>0?m=x[x.length-1]:m=null};function Ws(E,H,Q,q){if(E.visible===!1)return;if(E.layers.test(H.layers)){if(E.isGroup)Q=E.renderOrder;else if(E.isLOD)E.autoUpdate===!0&&E.update(H);else if(E.isLight)f.pushLight(E),E.castShadow&&f.pushShadow(E);else if(E.isSprite){if(!E.frustumCulled||W.intersectsSprite(E)){q&&He.setFromMatrixPosition(E.matrixWorld).applyMatrix4(Ie);let ye=te.update(E),Ce=E.material;Ce.visible&&m.push(E,ye,Ce,Q,He.z,null)}}else if((E.isMesh||E.isLine||E.isPoints)&&(!E.frustumCulled||W.intersectsObject(E))){let ye=te.update(E),Ce=E.material;if(q&&(E.boundingSphere!==void 0?(E.boundingSphere===null&&E.computeBoundingSphere(),He.copy(E.boundingSphere.center)):(ye.boundingSphere===null&&ye.computeBoundingSphere(),He.copy(ye.boundingSphere.center)),He.applyMatrix4(E.matrixWorld).applyMatrix4(Ie)),Array.isArray(Ce)){let Ee=ye.groups;for(let tt=0,it=Ee.length;tt<it;tt++){let Ye=Ee[tt],xt=Ce[Ye.materialIndex];xt&&xt.visible&&m.push(E,ye,xt,Q,He.z,Ye)}}else Ce.visible&&m.push(E,ye,Ce,Q,He.z,null)}}let de=E.children;for(let ye=0,Ce=de.length;ye<Ce;ye++)Ws(de[ye],H,Q,q)}function Xs(E,H,Q,q){let X=E.opaque,de=E.transmissive,ye=E.transparent;f.setupLightsView(Q),j===!0&&re.setGlobalState(y.clippingPlanes,Q),q&&Le.viewport(D.copy(q)),X.length>0&&Ys(X,H,Q),de.length>0&&Ys(de,H,Q),ye.length>0&&Ys(ye,H,Q),Le.buffers.depth.setTest(!0),Le.buffers.depth.setMask(!0),Le.buffers.color.setMask(!0),Le.setPolygonOffset(!1)}function wa(E,H,Q,q){if((Q.isScene===!0?Q.overrideMaterial:null)!==null)return;f.state.transmissionRenderTarget[q.id]===void 0&&(f.state.transmissionRenderTarget[q.id]=new Ht(1,1,{generateMipmaps:!0,type:Be.has("EXT_color_buffer_half_float")||Be.has("EXT_color_buffer_float")?Nr:kt,minFilter:gi,samples:4,stencilBuffer:r,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:pt.workingColorSpace}));let de=f.state.transmissionRenderTarget[q.id],ye=q.viewport||D;de.setSize(ye.z*y.transmissionResolutionScale,ye.w*y.transmissionResolutionScale);let Ce=y.getRenderTarget();y.setRenderTarget(de),y.getClearColor(N),V=y.getClearAlpha(),V<1&&y.setClearColor(16777215,.5),y.clear(),We&&Fe.render(Q);let Ee=y.toneMapping;y.toneMapping=Gi;let tt=q.viewport;if(q.viewport!==void 0&&(q.viewport=void 0),f.setupLightsView(q),j===!0&&re.setGlobalState(y.clippingPlanes,q),Ys(E,Q,q),w.updateMultisampleRenderTarget(de),w.updateRenderTargetMipmap(de),Be.has("WEBGL_multisampled_render_to_texture")===!1){let it=!1;for(let Ye=0,xt=H.length;Ye<xt;Ye++){let _t=H[Ye],ke=_t.object,ht=_t.geometry,dt=_t.material,je=_t.group;if(dt.side===vn&&ke.layers.test(q.layers)){let gn=dt.side;dt.side=an,dt.needsUpdate=!0,jc(ke,Q,q,ht,dt,je),dt.side=gn,dt.needsUpdate=!0,it=!0}}it===!0&&(w.updateMultisampleRenderTarget(de),w.updateRenderTargetMipmap(de))}y.setRenderTarget(Ce),y.setClearColor(N,V),tt!==void 0&&(q.viewport=tt),y.toneMapping=Ee}function Ys(E,H,Q){let q=H.isScene===!0?H.overrideMaterial:null;for(let X=0,de=E.length;X<de;X++){let ye=E[X],Ce=ye.object,Ee=ye.geometry,tt=q===null?ye.material:q,it=ye.group;Ce.layers.test(Q.layers)&&jc(Ce,H,Q,Ee,tt,it)}}function jc(E,H,Q,q,X,de){E.onBeforeRender(y,H,Q,q,X,de),E.modelViewMatrix.multiplyMatrices(Q.matrixWorldInverse,E.matrixWorld),E.normalMatrix.getNormalMatrix(E.modelViewMatrix),X.onBeforeRender(y,H,Q,q,E,de),X.transparent===!0&&X.side===vn&&X.forceSinglePass===!1?(X.side=an,X.needsUpdate=!0,y.renderBufferDirect(Q,H,q,X,E,de),X.side=Hn,X.needsUpdate=!0,y.renderBufferDirect(Q,H,q,X,E,de),X.side=vn):y.renderBufferDirect(Q,H,q,X,E,de),E.onAfterRender(y,H,Q,q,X,de)}function ne(E,H,Q){H.isScene!==!0&&(H=$e);let q=xe.get(E),X=f.state.lights,de=f.state.shadowsArray,ye=X.state.version,Ce=Z.getParameters(E,X.state,de,H,Q),Ee=Z.getProgramCacheKey(Ce),tt=q.programs;q.environment=E.isMeshStandardMaterial?H.environment:null,q.fog=H.fog,q.envMap=(E.isMeshStandardMaterial?Y:_).get(E.envMap||q.environment),q.envMapRotation=q.environment!==null&&E.envMap===null?H.environmentRotation:E.envMapRotation,tt===void 0&&(E.addEventListener("dispose",et),tt=new Map,q.programs=tt);let it=tt.get(Ee);if(it!==void 0){if(q.currentProgram===it&&q.lightsStateVersion===ye)return at(E,Ce),it}else Ce.uniforms=Z.getUniforms(E),E.onBeforeCompile(Ce,y),it=Z.acquireProgram(Ce,Ee),tt.set(Ee,it),q.uniforms=Ce.uniforms;let Ye=q.uniforms;return(!E.isShaderMaterial&&!E.isRawShaderMaterial||E.clipping===!0)&&(Ye.clippingPlanes=re.uniform),at(E,Ce),q.needsLights=yn(E),q.lightsStateVersion=ye,q.needsLights&&(Ye.ambientLightColor.value=X.state.ambient,Ye.lightProbe.value=X.state.probe,Ye.directionalLights.value=X.state.directional,Ye.directionalLightShadows.value=X.state.directionalShadow,Ye.spotLights.value=X.state.spot,Ye.spotLightShadows.value=X.state.spotShadow,Ye.rectAreaLights.value=X.state.rectArea,Ye.ltc_1.value=X.state.rectAreaLTC1,Ye.ltc_2.value=X.state.rectAreaLTC2,Ye.pointLights.value=X.state.point,Ye.pointLightShadows.value=X.state.pointShadow,Ye.hemisphereLights.value=X.state.hemi,Ye.directionalShadowMap.value=X.state.directionalShadowMap,Ye.directionalShadowMatrix.value=X.state.directionalShadowMatrix,Ye.spotShadowMap.value=X.state.spotShadowMap,Ye.spotLightMatrix.value=X.state.spotLightMatrix,Ye.spotLightMap.value=X.state.spotLightMap,Ye.pointShadowMap.value=X.state.pointShadowMap,Ye.pointShadowMatrix.value=X.state.pointShadowMatrix),q.currentProgram=it,q.uniformsList=null,it}function fe(E){if(E.uniformsList===null){let H=E.currentProgram.getUniforms();E.uniformsList=eo.seqWithValue(H.seq,E.uniforms)}return E.uniformsList}function at(E,H){let Q=xe.get(E);Q.outputColorSpace=H.outputColorSpace,Q.batching=H.batching,Q.batchingColor=H.batchingColor,Q.instancing=H.instancing,Q.instancingColor=H.instancingColor,Q.instancingMorph=H.instancingMorph,Q.skinning=H.skinning,Q.morphTargets=H.morphTargets,Q.morphNormals=H.morphNormals,Q.morphColors=H.morphColors,Q.morphTargetsCount=H.morphTargetsCount,Q.numClippingPlanes=H.numClippingPlanes,Q.numIntersection=H.numClipIntersection,Q.vertexAlphas=H.vertexAlphas,Q.vertexTangents=H.vertexTangents,Q.toneMapping=H.toneMapping}function Et(E,H,Q,q,X){H.isScene!==!0&&(H=$e),w.resetTextureUnits();let de=H.fog,ye=q.isMeshStandardMaterial?H.environment:null,Ce=R===null?y.outputColorSpace:R.isXRRenderTarget===!0?R.texture.colorSpace:Wt,Ee=(q.isMeshStandardMaterial?Y:_).get(q.envMap||ye),tt=q.vertexColors===!0&&!!Q.attributes.color&&Q.attributes.color.itemSize===4,it=!!Q.attributes.tangent&&(!!q.normalMap||q.anisotropy>0),Ye=!!Q.morphAttributes.position,xt=!!Q.morphAttributes.normal,_t=!!Q.morphAttributes.color,ke=Gi;q.toneMapped&&(R===null||R.isXRRenderTarget===!0)&&(ke=y.toneMapping);let ht=Q.morphAttributes.position||Q.morphAttributes.normal||Q.morphAttributes.color,dt=ht!==void 0?ht.length:0,je=xe.get(q),gn=f.state.lights;if(j===!0&&(ie===!0||E!==S)){let Mn=E===S&&q.id===b;re.setState(q,E,Mn)}let It=!1;q.version===je.__version?(je.needsLights&&je.lightsStateVersion!==gn.state.version||je.outputColorSpace!==Ce||X.isBatchedMesh&&je.batching===!1||!X.isBatchedMesh&&je.batching===!0||X.isBatchedMesh&&je.batchingColor===!0&&X.colorTexture===null||X.isBatchedMesh&&je.batchingColor===!1&&X.colorTexture!==null||X.isInstancedMesh&&je.instancing===!1||!X.isInstancedMesh&&je.instancing===!0||X.isSkinnedMesh&&je.skinning===!1||!X.isSkinnedMesh&&je.skinning===!0||X.isInstancedMesh&&je.instancingColor===!0&&X.instanceColor===null||X.isInstancedMesh&&je.instancingColor===!1&&X.instanceColor!==null||X.isInstancedMesh&&je.instancingMorph===!0&&X.morphTexture===null||X.isInstancedMesh&&je.instancingMorph===!1&&X.morphTexture!==null||je.envMap!==Ee||q.fog===!0&&je.fog!==de||je.numClippingPlanes!==void 0&&(je.numClippingPlanes!==re.numPlanes||je.numIntersection!==re.numIntersection)||je.vertexAlphas!==tt||je.vertexTangents!==it||je.morphTargets!==Ye||je.morphNormals!==xt||je.morphColors!==_t||je.toneMapping!==ke||je.morphTargetsCount!==dt)&&(It=!0):(It=!0,je.__version=q.version);let mi=je.currentProgram;It===!0&&(mi=ne(q,H,X));let Ir=!1,zn=!1,Ca=!1,Vt=mi.getUniforms(),ni=je.uniforms;if(Le.useProgram(mi.program)&&(Ir=!0,zn=!0,Ca=!0),q.id!==b&&(b=q.id,zn=!0),Ir||S!==E){Le.buffers.depth.getReversed()?(ue.copy(E.projectionMatrix),Kf(ue),Jf(ue),Vt.setValue(F,"projectionMatrix",ue)):Vt.setValue(F,"projectionMatrix",E.projectionMatrix),Vt.setValue(F,"viewMatrix",E.matrixWorldInverse);let In=Vt.map.cameraPosition;In!==void 0&&In.setValue(F,De.setFromMatrixPosition(E.matrixWorld)),qe.logarithmicDepthBuffer&&Vt.setValue(F,"logDepthBufFC",2/(Math.log(E.far+1)/Math.LN2)),(q.isMeshPhongMaterial||q.isMeshToonMaterial||q.isMeshLambertMaterial||q.isMeshBasicMaterial||q.isMeshStandardMaterial||q.isShaderMaterial)&&Vt.setValue(F,"isOrthographic",E.isOrthographicCamera===!0),S!==E&&(S=E,zn=!0,Ca=!0)}if(X.isSkinnedMesh){Vt.setOptional(F,X,"bindMatrix"),Vt.setOptional(F,X,"bindMatrixInverse");let Mn=X.skeleton;Mn&&(Mn.boneTexture===null&&Mn.computeBoneTexture(),Vt.setValue(F,"boneTexture",Mn.boneTexture,w))}X.isBatchedMesh&&(Vt.setOptional(F,X,"batchingTexture"),Vt.setValue(F,"batchingTexture",X._matricesTexture,w),Vt.setOptional(F,X,"batchingIdTexture"),Vt.setValue(F,"batchingIdTexture",X._indirectTexture,w),Vt.setOptional(F,X,"batchingColorTexture"),X._colorsTexture!==null&&Vt.setValue(F,"batchingColorTexture",X._colorsTexture,w));let ii=Q.morphAttributes;if((ii.position!==void 0||ii.normal!==void 0||ii.color!==void 0)&&Qe.update(X,Q,mi),(zn||je.receiveShadow!==X.receiveShadow)&&(je.receiveShadow=X.receiveShadow,Vt.setValue(F,"receiveShadow",X.receiveShadow)),q.isMeshGouraudMaterial&&q.envMap!==null&&(ni.envMap.value=Ee,ni.flipEnvMap.value=Ee.isCubeTexture&&Ee.isRenderTargetTexture===!1?-1:1),q.isMeshStandardMaterial&&q.envMap===null&&H.environment!==null&&(ni.envMapIntensity.value=H.environmentIntensity),zn&&(Vt.setValue(F,"toneMappingExposure",y.toneMappingExposure),je.needsLights&&Ot(ni,Ca),de&&q.fog===!0&&K.refreshFogUniforms(ni,de),K.refreshMaterialUniforms(ni,q,P,I,f.state.transmissionRenderTarget[E.id]),eo.upload(F,fe(je),ni,w)),q.isShaderMaterial&&q.uniformsNeedUpdate===!0&&(eo.upload(F,fe(je),ni,w),q.uniformsNeedUpdate=!1),q.isSpriteMaterial&&Vt.setValue(F,"center",X.center),Vt.setValue(F,"modelViewMatrix",X.modelViewMatrix),Vt.setValue(F,"normalMatrix",X.normalMatrix),Vt.setValue(F,"modelMatrix",X.matrixWorld),q.isShaderMaterial||q.isRawShaderMaterial){let Mn=q.uniformsGroups;for(let In=0,Zc=Mn.length;In<Zc;In++){let Qs=Mn[In];z.update(Qs,mi),z.bind(Qs,mi)}}return mi}function Ot(E,H){E.ambientLightColor.needsUpdate=H,E.lightProbe.needsUpdate=H,E.directionalLights.needsUpdate=H,E.directionalLightShadows.needsUpdate=H,E.pointLights.needsUpdate=H,E.pointLightShadows.needsUpdate=H,E.spotLights.needsUpdate=H,E.spotLightShadows.needsUpdate=H,E.rectAreaLights.needsUpdate=H,E.hemisphereLights.needsUpdate=H}function yn(E){return E.isMeshLambertMaterial||E.isMeshToonMaterial||E.isMeshPhongMaterial||E.isMeshStandardMaterial||E.isShadowMaterial||E.isShaderMaterial&&E.lights===!0}this.getActiveCubeFace=function(){return M},this.getActiveMipmapLevel=function(){return C},this.getRenderTarget=function(){return R},this.setRenderTargetTextures=function(E,H,Q){xe.get(E.texture).__webglTexture=H,xe.get(E.depthTexture).__webglTexture=Q;let q=xe.get(E);q.__hasExternalTextures=!0,q.__autoAllocateDepthBuffer=Q===void 0,q.__autoAllocateDepthBuffer||Be.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),q.__useRenderToTexture=!1)},this.setRenderTargetFramebuffer=function(E,H){let Q=xe.get(E);Q.__webglFramebuffer=H,Q.__useDefaultFramebuffer=H===void 0};let kn=F.createFramebuffer();this.setRenderTarget=function(E,H=0,Q=0){R=E,M=H,C=Q;let q=!0,X=null,de=!1,ye=!1;if(E){let Ee=xe.get(E);if(Ee.__useDefaultFramebuffer!==void 0)Le.bindFramebuffer(F.FRAMEBUFFER,null),q=!1;else if(Ee.__webglFramebuffer===void 0)w.setupRenderTarget(E);else if(Ee.__hasExternalTextures)w.rebindTextures(E,xe.get(E.texture).__webglTexture,xe.get(E.depthTexture).__webglTexture);else if(E.depthBuffer){let Ye=E.depthTexture;if(Ee.__boundDepthTexture!==Ye){if(Ye!==null&&xe.has(Ye)&&(E.width!==Ye.image.width||E.height!==Ye.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");w.setupDepthRenderbuffer(E)}}let tt=E.texture;(tt.isData3DTexture||tt.isDataArrayTexture||tt.isCompressedArrayTexture)&&(ye=!0);let it=xe.get(E).__webglFramebuffer;E.isWebGLCubeRenderTarget?(Array.isArray(it[H])?X=it[H][Q]:X=it[H],de=!0):E.samples>0&&w.useMultisampledRTT(E)===!1?X=xe.get(E).__webglMultisampledFramebuffer:Array.isArray(it)?X=it[Q]:X=it,D.copy(E.viewport),U.copy(E.scissor),O=E.scissorTest}else D.copy(ae).multiplyScalar(P).floor(),U.copy(ve).multiplyScalar(P).floor(),O=le;if(Q!==0&&(X=kn),Le.bindFramebuffer(F.FRAMEBUFFER,X)&&q&&Le.drawBuffers(E,X),Le.viewport(D),Le.scissor(U),Le.setScissorTest(O),de){let Ee=xe.get(E.texture);F.framebufferTexture2D(F.FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_CUBE_MAP_POSITIVE_X+H,Ee.__webglTexture,Q)}else if(ye){let Ee=xe.get(E.texture),tt=H;F.framebufferTextureLayer(F.FRAMEBUFFER,F.COLOR_ATTACHMENT0,Ee.__webglTexture,Q,tt)}else if(E!==null&&Q!==0){let Ee=xe.get(E.texture);F.framebufferTexture2D(F.FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_2D,Ee.__webglTexture,Q)}b=-1},this.readRenderTargetPixels=function(E,H,Q,q,X,de,ye){if(!(E&&E.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Ce=xe.get(E).__webglFramebuffer;if(E.isWebGLCubeRenderTarget&&ye!==void 0&&(Ce=Ce[ye]),Ce){Le.bindFramebuffer(F.FRAMEBUFFER,Ce);try{let Ee=E.texture,tt=Ee.format,it=Ee.type;if(!qe.textureFormatReadable(tt)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!qe.textureTypeReadable(it)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}H>=0&&H<=E.width-q&&Q>=0&&Q<=E.height-X&&F.readPixels(H,Q,q,X,Ge.convert(tt),Ge.convert(it),de)}finally{let Ee=R!==null?xe.get(R).__webglFramebuffer:null;Le.bindFramebuffer(F.FRAMEBUFFER,Ee)}}},this.readRenderTargetPixelsAsync=async function(E,H,Q,q,X,de,ye){if(!(E&&E.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Ce=xe.get(E).__webglFramebuffer;if(E.isWebGLCubeRenderTarget&&ye!==void 0&&(Ce=Ce[ye]),Ce){let Ee=E.texture,tt=Ee.format,it=Ee.type;if(!qe.textureFormatReadable(tt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!qe.textureTypeReadable(it))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");if(H>=0&&H<=E.width-q&&Q>=0&&Q<=E.height-X){Le.bindFramebuffer(F.FRAMEBUFFER,Ce);let Ye=F.createBuffer();F.bindBuffer(F.PIXEL_PACK_BUFFER,Ye),F.bufferData(F.PIXEL_PACK_BUFFER,de.byteLength,F.STREAM_READ),F.readPixels(H,Q,q,X,Ge.convert(tt),Ge.convert(it),0);let xt=R!==null?xe.get(R).__webglFramebuffer:null;Le.bindFramebuffer(F.FRAMEBUFFER,xt);let _t=F.fenceSync(F.SYNC_GPU_COMMANDS_COMPLETE,0);return F.flush(),await Zf(F,_t,4),F.bindBuffer(F.PIXEL_PACK_BUFFER,Ye),F.getBufferSubData(F.PIXEL_PACK_BUFFER,0,de),F.deleteBuffer(Ye),F.deleteSync(_t),de}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")}},this.copyFramebufferToTexture=function(E,H=null,Q=0){E.isTexture!==!0&&(sr("WebGLRenderer: copyFramebufferToTexture function signature has changed."),H=arguments[0]||null,E=arguments[1]);let q=Math.pow(2,-Q),X=Math.floor(E.image.width*q),de=Math.floor(E.image.height*q),ye=H!==null?H.x:0,Ce=H!==null?H.y:0;w.setTexture2D(E,0),F.copyTexSubImage2D(F.TEXTURE_2D,Q,0,0,ye,Ce,X,de),Le.unbindTexture()};let pi=F.createFramebuffer(),rn=F.createFramebuffer();this.copyTextureToTexture=function(E,H,Q=null,q=null,X=0,de=null){E.isTexture!==!0&&(sr("WebGLRenderer: copyTextureToTexture function signature has changed."),q=arguments[0]||null,E=arguments[1],H=arguments[2],de=arguments[3]||0,Q=null),de===null&&(X!==0?(sr("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),de=X,X=0):de=0);let ye,Ce,Ee,tt,it,Ye,xt,_t,ke,ht=E.isCompressedTexture?E.mipmaps[de]:E.image;if(Q!==null)ye=Q.max.x-Q.min.x,Ce=Q.max.y-Q.min.y,Ee=Q.isBox3?Q.max.z-Q.min.z:1,tt=Q.min.x,it=Q.min.y,Ye=Q.isBox3?Q.min.z:0;else{let ii=Math.pow(2,-X);ye=Math.floor(ht.width*ii),Ce=Math.floor(ht.height*ii),E.isDataArrayTexture?Ee=ht.depth:E.isData3DTexture?Ee=Math.floor(ht.depth*ii):Ee=1,tt=0,it=0,Ye=0}q!==null?(xt=q.x,_t=q.y,ke=q.z):(xt=0,_t=0,ke=0);let dt=Ge.convert(H.format),je=Ge.convert(H.type),gn;H.isData3DTexture?(w.setTexture3D(H,0),gn=F.TEXTURE_3D):H.isDataArrayTexture||H.isCompressedArrayTexture?(w.setTexture2DArray(H,0),gn=F.TEXTURE_2D_ARRAY):(w.setTexture2D(H,0),gn=F.TEXTURE_2D),F.pixelStorei(F.UNPACK_FLIP_Y_WEBGL,H.flipY),F.pixelStorei(F.UNPACK_PREMULTIPLY_ALPHA_WEBGL,H.premultiplyAlpha),F.pixelStorei(F.UNPACK_ALIGNMENT,H.unpackAlignment);let It=F.getParameter(F.UNPACK_ROW_LENGTH),mi=F.getParameter(F.UNPACK_IMAGE_HEIGHT),Ir=F.getParameter(F.UNPACK_SKIP_PIXELS),zn=F.getParameter(F.UNPACK_SKIP_ROWS),Ca=F.getParameter(F.UNPACK_SKIP_IMAGES);F.pixelStorei(F.UNPACK_ROW_LENGTH,ht.width),F.pixelStorei(F.UNPACK_IMAGE_HEIGHT,ht.height),F.pixelStorei(F.UNPACK_SKIP_PIXELS,tt),F.pixelStorei(F.UNPACK_SKIP_ROWS,it),F.pixelStorei(F.UNPACK_SKIP_IMAGES,Ye);let Vt=E.isDataArrayTexture||E.isData3DTexture,ni=H.isDataArrayTexture||H.isData3DTexture;if(E.isDepthTexture){let ii=xe.get(E),Mn=xe.get(H),In=xe.get(ii.__renderTarget),Zc=xe.get(Mn.__renderTarget);Le.bindFramebuffer(F.READ_FRAMEBUFFER,In.__webglFramebuffer),Le.bindFramebuffer(F.DRAW_FRAMEBUFFER,Zc.__webglFramebuffer);for(let Qs=0;Qs<Ee;Qs++)Vt&&(F.framebufferTextureLayer(F.READ_FRAMEBUFFER,F.COLOR_ATTACHMENT0,xe.get(E).__webglTexture,X,Ye+Qs),F.framebufferTextureLayer(F.DRAW_FRAMEBUFFER,F.COLOR_ATTACHMENT0,xe.get(H).__webglTexture,de,ke+Qs)),F.blitFramebuffer(tt,it,ye,Ce,xt,_t,ye,Ce,F.DEPTH_BUFFER_BIT,F.NEAREST);Le.bindFramebuffer(F.READ_FRAMEBUFFER,null),Le.bindFramebuffer(F.DRAW_FRAMEBUFFER,null)}else if(X!==0||E.isRenderTargetTexture||xe.has(E)){let ii=xe.get(E),Mn=xe.get(H);Le.bindFramebuffer(F.READ_FRAMEBUFFER,pi),Le.bindFramebuffer(F.DRAW_FRAMEBUFFER,rn);for(let In=0;In<Ee;In++)Vt?F.framebufferTextureLayer(F.READ_FRAMEBUFFER,F.COLOR_ATTACHMENT0,ii.__webglTexture,X,Ye+In):F.framebufferTexture2D(F.READ_FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_2D,ii.__webglTexture,X),ni?F.framebufferTextureLayer(F.DRAW_FRAMEBUFFER,F.COLOR_ATTACHMENT0,Mn.__webglTexture,de,ke+In):F.framebufferTexture2D(F.DRAW_FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_2D,Mn.__webglTexture,de),X!==0?F.blitFramebuffer(tt,it,ye,Ce,xt,_t,ye,Ce,F.COLOR_BUFFER_BIT,F.NEAREST):ni?F.copyTexSubImage3D(gn,de,xt,_t,ke+In,tt,it,ye,Ce):F.copyTexSubImage2D(gn,de,xt,_t,tt,it,ye,Ce);Le.bindFramebuffer(F.READ_FRAMEBUFFER,null),Le.bindFramebuffer(F.DRAW_FRAMEBUFFER,null)}else ni?E.isDataTexture||E.isData3DTexture?F.texSubImage3D(gn,de,xt,_t,ke,ye,Ce,Ee,dt,je,ht.data):H.isCompressedArrayTexture?F.compressedTexSubImage3D(gn,de,xt,_t,ke,ye,Ce,Ee,dt,ht.data):F.texSubImage3D(gn,de,xt,_t,ke,ye,Ce,Ee,dt,je,ht):E.isDataTexture?F.texSubImage2D(F.TEXTURE_2D,de,xt,_t,ye,Ce,dt,je,ht.data):E.isCompressedTexture?F.compressedTexSubImage2D(F.TEXTURE_2D,de,xt,_t,ht.width,ht.height,dt,ht.data):F.texSubImage2D(F.TEXTURE_2D,de,xt,_t,ye,Ce,dt,je,ht);F.pixelStorei(F.UNPACK_ROW_LENGTH,It),F.pixelStorei(F.UNPACK_IMAGE_HEIGHT,mi),F.pixelStorei(F.UNPACK_SKIP_PIXELS,Ir),F.pixelStorei(F.UNPACK_SKIP_ROWS,zn),F.pixelStorei(F.UNPACK_SKIP_IMAGES,Ca),de===0&&H.generateMipmaps&&F.generateMipmap(gn),Le.unbindTexture()},this.copyTextureToTexture3D=function(E,H,Q=null,q=null,X=0){return E.isTexture!==!0&&(sr("WebGLRenderer: copyTextureToTexture3D function signature has changed."),Q=arguments[0]||null,q=arguments[1]||null,E=arguments[2],H=arguments[3],X=arguments[4]||0),sr('WebGLRenderer: copyTextureToTexture3D function has been deprecated. Use "copyTextureToTexture" instead.'),this.copyTextureToTexture(E,H,Q,q,X)},this.initRenderTarget=function(E){xe.get(E).__webglFramebuffer===void 0&&w.setupRenderTarget(E)},this.initTexture=function(E){E.isCubeTexture?w.setTextureCube(E,0):E.isData3DTexture?w.setTexture3D(E,0):E.isDataArrayTexture||E.isCompressedArrayTexture?w.setTexture2DArray(E,0):w.setTexture2D(E,0),Le.unbindTexture()},this.resetState=function(){M=0,C=0,R=null,Le.reset(),Pt.reset()},typeof __THREE_DEVTOOLS__!="undefined"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return xi}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;let t=this.getContext();t.drawingBufferColorspace=pt._getDrawingBufferColorSpace(e),t.unpackColorSpace=pt._getUnpackColorSpace()}};var Tu=class extends HTMLElement{constructor(){super()}static get observedAttributes(){return["path"]}connectedCallback(){this.loadSponsors()}attributeChangedCallback(e,t,n){t!==n&&this.loadSponsors()}get path(){return this.getAttribute("path")||"github-sponsors"}async loadSponsors(){try{let e=await fetch(window.paths[this.path]);if(!e.ok)throw new Error(`HTTP error! status: ${e.status}`);let t=await e.text();this.innerHTML=t}catch(e){console.error("Error loading sponsors:",e),this.innerHTML=""}}};var Ti=typeof window!="undefined",Cn=Ti?window:null,Ve=Ti?document:null,jt={OBJECT:0,ATTRIBUTE:1,CSS:2,TRANSFORM:3,CSS_VAR:4},St={NUMBER:0,UNIT:1,COLOR:2,COMPLEX:3},Kn={NONE:0,AUTO:1,FORCE:2},mn={replace:0,none:1,blend:2},wm=Symbol(),Ac=Symbol(),Mu=Symbol(),io=Symbol(),Cm=Symbol(),Rm=Symbol(),Tt=1e-11,ua=1e12,Jt=1e3,wu=120,rs="",Cu=(()=>{let i=new Map;return i.set("x","translateX"),i.set("y","translateY"),i.set("z","translateZ"),i})(),so=["translateX","translateY","translateZ","rotate","rotateX","rotateY","rotateZ","scale","scaleX","scaleY","scaleZ","skew","skewX","skewY","perspective","matrix","matrix3d"],Ru=so.reduce((i,e)=>({...i,[e]:e+"("}),{}),rt=()=>{},SS=/(^#([\da-f]{3}){1,2}$)|(^#([\da-f]{4}){1,2}$)/i,bS=/rgb\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*\)/i,ES=/rgba\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*,\s*(-?\d+|-?\d*.\d+)\s*\)/i,TS=/hsl\(\s*(-?\d+|-?\d*.\d+)\s*,\s*(-?\d+|-?\d*.\d+)%\s*,\s*(-?\d+|-?\d*.\d+)%\s*\)/i,MS=/hsla\(\s*(-?\d+|-?\d*.\d+)\s*,\s*(-?\d+|-?\d*.\d+)%\s*,\s*(-?\d+|-?\d*.\d+)%\s*,\s*(-?\d+|-?\d*.\d+)\s*\)/i,Dm=/[-+]?\d*\.?\d+(?:e[-+]?\d)?/gi,Pm=/^([-+]?\d*\.?\d+(?:e[-+]?\d+)?)([a-z]+|%)$/i,wS=/([a-z])([A-Z])/g,CS=/(\w+)(\([^)]+\)+)/g,Im=/(\*=|\+=|-=)/,Lm={id:null,keyframes:null,playbackEase:null,playbackRate:1,frameRate:wu,loop:0,reversed:!1,alternate:!1,autoplay:!0,duration:Jt,delay:0,loopDelay:0,ease:"out(2)",composition:mn.replace,modifier:i=>i,onBegin:rt,onBeforeUpdate:rt,onUpdate:rt,onLoop:rt,onPause:rt,onComplete:rt,onRender:rt},nn={current:null,root:Ve},lt={defaults:Lm,precision:4,timeScale:1,tickThreshold:200},Fm={version:"4.1.1",engine:null};Ti&&(Cn.AnimeJS||(Cn.AnimeJS=[]),Cn.AnimeJS.push(Fm));var Um=i=>i.replace(wS,"$1-$2").toLowerCase(),un=(i,e)=>i.indexOf(e)===0,xr=Date.now,Rn=Array.isArray,ln=i=>i&&i.constructor===Object,Jn=i=>typeof i=="number"&&!isNaN(i),Fn=i=>typeof i=="string",Zt=i=>typeof i=="function",Se=i=>typeof i=="undefined",ro=i=>Se(i)||i===null,Du=i=>Ti&&i instanceof SVGElement,Nm=i=>SS.test(i),Bm=i=>un(i,"rgb"),Om=i=>un(i,"hsl"),RS=i=>Nm(i)||Bm(i)||Om(i),da=i=>!lt.defaults.hasOwnProperty(i),yr=i=>Fn(i)?parseFloat(i):i,fa=Math.pow,Ls=Math.sqrt,Pu=Math.sin,Iu=Math.cos,Ni=Math.abs,km=Math.exp,DS=Math.ceil,ao=Math.floor,PS=Math.asin,zm=Math.max,_c=Math.atan2,pa=Math.PI,Lu=Math.round,Xe=(i,e,t)=>i<e?e:i>t?t:i,Hm={},Ne=(i,e)=>{if(e<0)return i;if(!e)return Lu(i);let t=Hm[e];return t||(t=Hm[e]=10**e),Lu(i*t)/t},Ar=(i,e)=>Rn(e)?e.reduce((t,n)=>Ni(n-i)<Ni(t-i)?n:t):e?Lu(i/e)*e:i,as=(i,e,t)=>i+(e-i)*t,Fu=(i,e,t)=>{let n=10**(t||0);return ao((Math.random()*(e-i+1/n)+i)*n)/n},Gm=i=>{let e=i.length,t,n;for(;e;)n=Fu(0,--e),t=i[e],i[e]=i[n],i[n]=t;return i},Sc=i=>i===1/0?ua:i===-1/0?-1e12:i,ma=i=>i<=Tt?Tt:Sc(Ne(i,11)),Dn=i=>Rn(i)?[...i]:i,oo=(i,e)=>{let t={...i};for(let n in e){let s=i[n];t[n]=Se(s)?e[n]:s}return t},Lt=(i,e,t,n="_prev",s="_next")=>{let r=i._head,a=s;for(t&&(r=i._tail,a=n);r;){let o=r[a];e(r),r=o}},os=(i,e,t="_prev",n="_next")=>{let s=e[t],r=e[n];s?s[n]=r:i._head=r,r?r[t]=s:i._tail=s,e[t]=null,e[n]=null},ls=(i,e,t,n="_prev",s="_next")=>{let r=i._tail;for(;r&&t&&t(r,e);)r=r[n];let a=r?r[s]:i._head;r?r[s]=e:i._head=e,a?a[n]=e:i._tail=e,e[n]=r,e[s]=a},Uu=i=>{let e;return(...t)=>{let n,s,r,a;e&&(n=e.currentIteration,s=e.iterationProgress,r=e.reversed,a=e._alternate,e.revert());let o=i(...t);return o&&!Zt(o)&&o.revert&&(e=o),Se(s)||(e.currentIteration=n,e.iterationProgress=(a&&n%2?!r:r)?1-s:s),o||rt}},Nu=class{constructor(e=0){this.deltaTime=0,this._currentTime=e,this._elapsedTime=e,this._startTime=e,this._lastTime=e,this._scheduledTime=0,this._frameDuration=Ne(Jt/wu,0),this._fps=wu,this._speed=1,this._hasChildren=!1,this._head=null,this._tail=null}get fps(){return this._fps}set fps(e){let t=this._frameDuration,n=+e,s=n<Tt?Tt:n,r=Ne(Jt/s,0);this._fps=s,this._frameDuration=r,this._scheduledTime+=r-t}get speed(){return this._speed}set speed(e){let t=+e;this._speed=t<Tt?Tt:t}requestTick(e){let t=this._scheduledTime,n=this._elapsedTime;if(this._elapsedTime+=e-n,n<t)return Kn.NONE;let s=this._frameDuration,r=n-t;return this._scheduledTime+=r<s?s:r,Kn.AUTO}computeDeltaTime(e){let t=e-this._lastTime;return this.deltaTime=t,this._lastTime=e,t}},bc=(i,e,t,n,s)=>{let r=i.parent,a=i.duration,o=i.completed,l=i.iterationDuration,c=i.iterationCount,h=i._currentIteration,u=i._loopDelay,d=i._reversed,p=i._alternate,g=i._hasChildren,v=i._delay,m=i._currentTime,f=v+l,x=e-v,A=Xe(m,-v,a),y=Xe(x,-v,a),T=x-m,M=y>0,C=y>=a,R=a<=Tt,b=s===Kn.FORCE,S=0,D=x,U=0;if(c>1){let I=~~(y/(l+(C?0:u)));i._currentIteration=Xe(I,0,c),C&&i._currentIteration--,S=i._currentIteration%2,D=y%(l+u)||0}let O=d^(p&&S),N=i._ease,V=C?O?0:a:O?l-D:D;N&&(V=l*N(V/l)||0);let B=(r?r.backwards:x<m)?!O:!!O;if(i._currentTime=x,i._iterationTime=V,i.backwards=B,M&&!i.began?(i.began=!0,!t&&!(r&&(B||!r.began))&&i.onBegin(i)):x<=0&&(i.began=!1),!t&&!g&&M&&i._currentIteration!==h&&i.onLoop(i),b||s===Kn.AUTO&&(e>=v&&e<=f||e<=v&&A>v||e>=f&&A!==a)||V>=f&&A!==a||V<=v&&A>0||e<=A&&A===a&&o||C&&!o&&R){if(M&&(i.computeDeltaTime(A),t||i.onBeforeUpdate(i)),!g){let I=b||(B?T*-1:T)>=lt.tickThreshold,P=i._offset+(r?r._offset:0)+v+V,L=i._head,J,ae,ve,le,W=0;for(;L;){let j=L._composition,ie=L._currentTime,ue=L._changeDuration,Ie=L._absoluteStartTime+L._changeDuration,De=L._nextRep,He=L._prevRep,$e=j!==mn.none;if((I||(ie!==ue||P<=Ie+(De?De._delay:0))&&(ie!==0||P>=L._absoluteStartTime))&&(!$e||!L._isOverridden&&(!L._isOverlapped||P<=Ie)&&(!De||De._isOverridden||P<=De._absoluteStartTime)&&(!He||He._isOverridden||P>=He._absoluteStartTime+He._changeDuration+L._delay))){let We=L._currentTime=Xe(V-L._startTime,0,ue),Je=L._ease(We/L._updateDuration),F=L._modifier,Dt=L._valueType,Be=L._tweenType,qe=Be===jt.OBJECT,Le=Dt===St.NUMBER,pe=Le&&qe||Je===0||Je===1?-1:lt.precision,xe,w;if(Le)xe=w=F(Ne(as(L._fromNumber,L._toNumber,Je),pe));else if(Dt===St.UNIT)w=F(Ne(as(L._fromNumber,L._toNumber,Je),pe)),xe=`${w}${L._unit}`;else if(Dt===St.COLOR){let _=L._fromNumbers,Y=L._toNumbers,$=Ne(Xe(F(as(_[0],Y[0],Je)),0,255),0),se=Ne(Xe(F(as(_[1],Y[1],Je)),0,255),0),te=Ne(Xe(F(as(_[2],Y[2],Je)),0,255),0),Z=Xe(F(Ne(as(_[3],Y[3],Je),pe)),0,1);if(xe=`rgba(${$},${se},${te},${Z})`,$e){let K=L._numbers;K[0]=$,K[1]=se,K[2]=te,K[3]=Z}}else if(Dt===St.COMPLEX){xe=L._strings[0];for(let _=0,Y=L._toNumbers.length;_<Y;_++){let $=F(Ne(as(L._fromNumbers[_],L._toNumbers[_],Je),pe)),se=L._strings[_+1];xe+=`${se?$+se:$}`,$e&&(L._numbers[_]=$)}}if($e&&(L._number=w),!n&&j!==mn.blend){let _=L.property;J=L.target,qe?J[_]=xe:Be===jt.ATTRIBUTE?J.setAttribute(_,xe):(ae=J.style,Be===jt.TRANSFORM?(J!==ve&&(ve=J,le=J[io]),le[_]=xe,W=1):Be===jt.CSS?ae[_]=xe:Be===jt.CSS_VAR&&ae.setProperty(_,xe)),M&&(U=1)}else L._value=xe}if(W&&L._renderTransforms){let We=rs;for(let Je in le)We+=`${Ru[Je]}${le[Je]}) `;ae.transform=We,W=0}L=L._next}!t&&U&&i.onRender(i)}!t&&M&&i.onUpdate(i)}return r&&R?!t&&(r.began&&!B&&x>=a&&!o||B&&x<=Tt&&o)&&(i.onComplete(i),i.completed=!B):M&&C?c===1/0?i._startTime+=i.duration:i._currentIteration>=c-1&&(i.paused=!0,!o&&!g&&(i.completed=!0,!t&&!(r&&(B||!r.began))&&(i.onComplete(i),i._resolve(i)))):i.completed=!1,U},_r=(i,e,t,n,s)=>{let r=i._currentIteration;if(bc(i,e,t,n,s),i._hasChildren){let a=i,o=a.backwards,l=n?e:a._iterationTime,c=xr(),h=0,u=!0;if(!n&&a._currentIteration!==r){let d=a.iterationDuration;Lt(a,p=>{if(!o)!p.completed&&!p.backwards&&p._currentTime<p.iterationDuration&&bc(p,d,t,1,Kn.FORCE),p.began=!1,p.completed=!1;else{let g=p.duration,v=p._offset+p._delay,m=v+g;!t&&g<=Tt&&(!v||m===d)&&p.onComplete(p)}}),t||a.onLoop(a)}Lt(a,d=>{let p=Ne((l-d._offset)*d._speed,12),g=d._fps<a._fps?d.requestTick(c):s;h+=bc(d,p,t,n,g),!d.completed&&u&&(u=!1)},o),!t&&h&&a.onRender(a),u&&a._currentTime>=a.duration&&(a.paused=!0,a.completed||(a.completed=!0,t||(a.onComplete(a),a._resolve(a))))}},ga={animation:null,update:rt},IS=i=>{let e=ga.animation;return e||(e={duration:Tt,computeDeltaTime:rt,_offset:0,_delay:0,_head:null,_tail:null},ga.animation=e,ga.update=()=>{i.forEach(t=>{for(let n in t){let s=t[n],r=s._head;if(r){let a=r._valueType,o=a===St.COMPLEX||a===St.COLOR?Dn(r._fromNumbers):null,l=r._fromNumber,c=s._tail;for(;c&&c!==r;){if(o)for(let h=0,u=c._numbers.length;h<u;h++)o[h]+=c._numbers[h];else l+=c._number;c=c._prevAdd}r._toNumber=l,r._toNumbers=o}}}),bc(e,1,1,0,Kn.FORCE)}),e},Vm=(()=>Ti?requestAnimationFrame:setImmediate)(),LS=(()=>Ti?cancelAnimationFrame:clearImmediate)(),Wm=class extends Nu{constructor(e){super(e);this.useDefaultMainLoop=!0,this.pauseOnDocumentHidden=!0,this.defaults=Lm,this.paused=!!(Ti&&Ve.hidden),this.reqId=null}update(){let e=this._currentTime=xr();if(this.requestTick(e)){this.computeDeltaTime(e);let t=this._speed,n=this._fps,s=this._head;for(;s;){let r=s._next;s.paused?(os(this,s),this._hasChildren=!!this._tail,s._running=!1,s.completed&&!s._cancelled&&s.cancel()):_r(s,(e-s._startTime)*s._speed*t,0,0,s._fps<n?s.requestTick(e):Kn.AUTO),s=r}ga.update()}}wake(){return this.useDefaultMainLoop&&!this.reqId&&!this.paused&&(this.reqId=Vm(Xm)),this}pause(){return this.paused=!0,FS()}resume(){if(!!this.paused)return this.paused=!1,Lt(this,e=>e.resetTime()),this.wake()}get speed(){return this._speed*(lt.timeScale===1?1:Jt)}set speed(e){this._speed=e*lt.timeScale,Lt(this,t=>t.speed=t._speed)}get timeUnit(){return lt.timeScale===1?"ms":"s"}set timeUnit(e){let t=.001,n=e==="s",s=n?t:1;if(lt.timeScale!==s){lt.timeScale=s,lt.tickThreshold=200*s;let r=n?t:Jt;this.defaults.duration*=r,this._speed*=r}}get precision(){return lt.precision}set precision(e){lt.precision=e}},sn=(()=>{let i=new Wm(xr());return Ti&&(Fm.engine=i,Ve.addEventListener("visibilitychange",()=>{!i.pauseOnDocumentHidden||(Ve.hidden?i.pause():i.resume())})),i})(),Xm=()=>{sn._head?(sn.reqId=Vm(Xm),sn.update()):sn.reqId=0},FS=()=>(LS(sn.reqId),sn.reqId=0,sn),US=(i,e,t)=>{let n=i.style.transform,s;if(n){let r=i[io],a;for(;a=CS.exec(n);){let o=a[1],l=a[2].slice(1,-1);r[o]=l,o===e&&(s=l,t&&(t[e]=l))}}return n&&!Se(s)?s:un(e,"scale")?"1":un(e,"rotate")||un(e,"skew")?"0deg":"0px"};function Bu(i){let e=Fn(i)?nn.root.querySelectorAll(i):i;if(e instanceof NodeList||e instanceof HTMLCollection)return e}function ci(i){if(ro(i))return[];if(Rn(i)){let t=i.flat(1/0),n=[];for(let s=0,r=t.length;s<r;s++){let a=t[s];if(!ro(a)){let o=Bu(a);if(o)for(let l=0,c=o.length;l<c;l++){let h=o[l];if(!ro(h)){let u=!1;for(let d=0,p=n.length;d<p;d++)if(n[d]===h){u=!0;break}u||n.push(h)}}else{let l=!1;for(let c=0,h=n.length;c<h;c++)if(n[c]===a){l=!0;break}l||n.push(a)}}}return n}if(!Ti)return[i];let e=Bu(i);return e?Array.from(e):[i]}function lo(i){let e=ci(i),t=e.length;if(t)for(let n=0;n<t;n++){let s=e[n];if(!s[wm]){s[wm]=!0;let r=Du(s);(s.nodeType||r)&&(s[Ac]=!0,s[Mu]=r,s[io]={})}}return e}var Ym=i=>{let t=ci(i)[0];if(!(!t||!Du(t)))return t},NS=(i,e=.33)=>t=>{let n=Ym(i);if(!n)return;let s=t.tagName==="path",r=s?" ":",",a=t[Cm];a&&t.setAttribute(s?"d":"points",a);let o="",l="";if(!e)o=t.getAttribute(s?"d":"points"),l=n.getAttribute(s?"d":"points");else{let c=t.getTotalLength(),h=n.getTotalLength(),u=Math.max(Math.ceil(c*e),Math.ceil(h*e));for(let d=0;d<u;d++){let p=d/(u-1),g=t.getPointAtLength(c*p),v=n.getPointAtLength(h*p),m=s?d===0?"M":"L":"";o+=m+Ne(g.x,3)+r+g.y+" ",l+=m+Ne(v.x,3)+r+v.y+" "}}return t[Cm]=l,[o,l]},BS=i=>{let e=1;if(i&&i.getCTM){let t=i.getCTM();if(t){let n=Ls(t.a*t.a+t.b*t.b),s=Ls(t.c*t.c+t.d*t.d);e=(n+s)/2}}return e},OS=(i,e,t)=>{let n=Jt,s=getComputedStyle(i),r=s.strokeLinecap,a=s.vectorEffect==="non-scaling-stroke"?i:null,o=r,l=new Proxy(i,{get(c,h){let u=c[h];return h===Rm?c:h==="setAttribute"?(...d)=>{if(d[0]==="draw"){let g=d[1].split(" "),v=+g[0],m=+g[1],f=BS(a),x=v*-1e3*f,A=m*n*f+x,y=n*f+(v===0&&m===1||v===1&&m===0?0:10*f)-A;if(r!=="butt"){let T=v===m?"butt":r;o!==T&&(c.style.strokeLinecap=`${T}`,o=T)}c.setAttribute("stroke-dashoffset",`${x}`),c.setAttribute("stroke-dasharray",`${A} ${y}`)}return Reflect.apply(u,c,d)}:Zt(u)?(...d)=>Reflect.apply(u,c,d):u}});return i.getAttribute("pathLength")!==`${n}`&&(i.setAttribute("pathLength",`${n}`),l.setAttribute("draw",`${e} ${t}`)),l},kS=(i,e=0,t=0)=>ci(i).map(s=>OS(s,e,t)),Ou=(i,e,t=0)=>i.getPointAtLength(e+t>=1?e+t:0),ku=(i,e)=>t=>{let n=+i.getTotalLength(),s=t[Mu],r=i.getCTM();return{from:0,to:n,modifier:a=>{if(e==="a"){let o=Ou(i,a,-1),l=Ou(i,a,1);return _c(l.y-o.y,l.x-o.x)*180/pa}else{let o=Ou(i,a,0);return e==="x"?s||!r?o.x:o.x*r.a+o.y*r.c+r.e:s||!r?o.y:o.x*r.b+o.y*r.d+r.f}}}},zS=i=>{let e=Ym(i);if(!!e)return{translateX:ku(e,"x"),translateY:ku(e,"y"),rotate:ku(e,"a")}},HS=["opacity","rotate","overflow","color"],GS=(i,e)=>{if(HS.includes(e))return!1;if(i.getAttribute(e)||e in i){if(e==="scale"){let t=i.parentNode;return t&&t.tagName==="filter"}return!0}},$n={morphTo:NS,createMotionPath:zS,createDrawable:kS},VS=i=>{let e=bS.exec(i)||ES.exec(i),t=Se(e[4])?1:+e[4];return[+e[1],+e[2],+e[3],t]},WS=i=>{let e=i.length,t=e===4||e===5;return[+("0x"+i[1]+i[t?1:2]),+("0x"+i[t?2:3]+i[t?2:4]),+("0x"+i[t?3:5]+i[t?3:6]),e===5||e===9?+(+("0x"+i[t?4:7]+i[t?4:8])/255).toFixed(3):1]},zu=(i,e,t)=>(t<0&&(t+=1),t>1&&(t-=1),t<1/6?i+(e-i)*6*t:t<1/2?e:t<2/3?i+(e-i)*(2/3-t)*6:i),XS=i=>{let e=TS.exec(i)||MS.exec(i),t=+e[1]/360,n=+e[2]/100,s=+e[3]/100,r=Se(e[4])?1:+e[4],a,o,l;if(n===0)a=o=l=s;else{let c=s<.5?s*(1+n):s+n-s*n,h=2*s-c;a=Ne(zu(h,c,t+1/3)*255,0),o=Ne(zu(h,c,t)*255,0),l=Ne(zu(h,c,t-1/3)*255,0)}return[a,o,l,r]},YS=i=>Bm(i)?VS(i):Nm(i)?WS(i):Om(i)?XS(i):[0,0,0,1],ze=(i,e)=>Se(i)?e:i,ei=(i,e,t,n,s)=>{if(Zt(i)){let r=()=>{let a=i(e,t,n);return isNaN(+a)?a||0:+a};return s&&(s.func=r),r()}else return i},Hu=(i,e)=>i[Ac]?i[Mu]&&GS(i,e)?jt.ATTRIBUTE:so.includes(e)||Cu.get(e)?jt.TRANSFORM:un(e,"--")?jt.CSS_VAR:e in i.style?jt.CSS:e in i?jt.OBJECT:jt.ATTRIBUTE:jt.OBJECT,Qm=(i,e,t)=>{let n=i.style[e];n&&t&&(t[e]=n);let s=n||getComputedStyle(i[Rm]||i).getPropertyValue(e);return s==="auto"?"0":s},Sr=(i,e,t,n)=>{let s=Se(t)?Hu(i,e):t;return s===jt.OBJECT?i[e]||0:s===jt.ATTRIBUTE?i.getAttribute(e):s===jt.TRANSFORM?US(i,e,n):s===jt.CSS_VAR?Qm(i,e,n).trimStart():Qm(i,e,n)},va=(i,e,t)=>t==="-"?i-e:t==="+"?i+e:i*e,Gu=()=>({t:St.NUMBER,n:0,u:null,o:null,d:null,s:null}),hi=(i,e)=>{if(e.t=St.NUMBER,e.n=0,e.u=null,e.o=null,e.d=null,e.s=null,!i)return e;let t=+i;if(isNaN(t)){let n=i;n[1]==="="&&(e.o=n[0],n=n.slice(2));let s=n.includes(" ")?!1:Pm.exec(n);if(s)return e.t=St.UNIT,e.n=+s[1],e.u=s[2],e;if(e.o)return e.n=+n,e;if(RS(n))return e.t=St.COLOR,e.d=YS(n),e;{let r=n.match(Dm);return e.t=St.COMPLEX,e.d=r?r.map(Number):[],e.s=n.split(Dm)||[],e}}else return e.n=t,e},qm=(i,e)=>(e.t=i._valueType,e.n=i._toNumber,e.u=i._unit,e.o=null,e.d=Dn(i._toNumbers),e.s=Dn(i._strings),e),Un=Gu(),Ec={_rep:new WeakMap,_add:new Map},Vu=(i,e,t="_rep")=>{let n=Ec[t],s=n.get(i);return s||(s={},n.set(i,s)),s[e]?s[e]:s[e]={_head:null,_tail:null}},QS=(i,e)=>i._isOverridden||i._absoluteStartTime>e._absoluteStartTime,Tc=i=>{i._isOverlapped=1,i._isOverridden=1,i._changeDuration=Tt,i._currentTime=Tt},jm=(i,e)=>{let t=i._composition;if(t===mn.replace){let n=i._absoluteStartTime;ls(e,i,QS,"_prevRep","_nextRep");let s=i._prevRep;if(s){let r=s.parent,a=s._absoluteStartTime+s._changeDuration;if(i.parent.id!==r.id&&r.iterationCount>1&&a+(r.duration-r.iterationDuration)>n){Tc(s);let c=s._prevRep;for(;c&&c.parent.id===r.id;)Tc(c),c=c._prevRep}let o=n-i._delay;if(a>o){let c=s._startTime,h=a-(c+s._updateDuration);s._changeDuration=o-h-c,s._currentTime=s._changeDuration,s._isOverlapped=1,s._changeDuration<Tt&&Tc(s)}let l=!0;if(Lt(r,c=>{c._isOverlapped||(l=!1)}),l){let c=r.parent;if(c){let h=!0;Lt(c,u=>{u!==r&&Lt(u,d=>{d._isOverlapped||(h=!1)})}),h&&c.cancel()}else r.cancel()}}}else if(t===mn.blend){let n=Vu(i.target,i.property,"_add"),s=IS(Ec._add),r=n._head;r||(r={...i},r._composition=mn.replace,r._updateDuration=Tt,r._startTime=0,r._numbers=Dn(i._fromNumbers),r._number=0,r._next=null,r._prev=null,ls(n,r),ls(s,r));let a=i._toNumber;if(i._fromNumber=r._fromNumber-a,i._toNumber=0,i._numbers=Dn(i._fromNumbers),i._number=0,r._fromNumber=a,i._toNumbers){let o=Dn(i._toNumbers);o&&o.forEach((l,c)=>{i._fromNumbers[c]=r._fromNumbers[c]-l,i._toNumbers[c]=0}),r._fromNumbers=o}ls(n,i,null,"_prevAdd","_nextAdd")}return i},Zm=i=>{let e=i._composition;if(e!==mn.none){let t=i.target,n=i.property,a=Ec._rep.get(t)[n];if(os(a,i,"_prevRep","_nextRep"),e===mn.blend){let o=Ec._add,l=o.get(t);if(!l)return;let c=l[n],h=ga.animation;os(c,i,"_prevAdd","_nextAdd");let u=c._head;if(u&&u===c._tail){os(c,u,"_prevAdd","_nextAdd"),os(h,u);let d=!0;for(let p in l)if(l[p]._head){d=!1;break}d&&o.delete(t)}}}return i},Km=i=>(i.paused=!0,i.began=!1,i.completed=!1,i),Wu=i=>(i._cancelled&&(i._hasChildren?Lt(i,Wu):Lt(i,e=>{e._composition!==mn.none&&jm(e,Vu(e.target,e.property))}),i._cancelled=0),i),qS=0,Nn=class extends Nu{constructor(e={},t=null,n=0){super(0);let{id:s,delay:r,duration:a,reversed:o,alternate:l,loop:c,loopDelay:h,autoplay:u,frameRate:d,playbackRate:p,onComplete:g,onLoop:v,onPause:m,onBegin:f,onBeforeUpdate:x,onUpdate:A}=e;nn.current&&nn.current.register(this);let y=t?0:sn._elapsedTime,T=t?t.defaults:lt.defaults,M=Zt(r)||Se(r)?T.delay:+r,C=Zt(a)||Se(a)?1/0:+a,R=ze(c,T.loop),b=ze(h,T.loopDelay),S=R===!0||R===1/0||R<0?1/0:R+1,D=0;if(t)D=n;else{let U=xr();sn.paused&&(sn.requestTick(U),U=sn._elapsedTime),D=U-sn._startTime}this.id=Se(s)?++qS:s,this.parent=t,this.duration=Sc((C+b)*S-b)||Tt,this.backwards=!1,this.paused=!0,this.began=!1,this.completed=!1,this.onBegin=f||T.onBegin,this.onBeforeUpdate=x||T.onBeforeUpdate,this.onUpdate=A||T.onUpdate,this.onLoop=v||T.onLoop,this.onPause=m||T.onPause,this.onComplete=g||T.onComplete,this.iterationDuration=C,this.iterationCount=S,this._autoplay=t?!1:ze(u,T.autoplay),this._offset=D,this._delay=M,this._loopDelay=b,this._iterationTime=0,this._currentIteration=0,this._resolve=rt,this._running=!1,this._reversed=+ze(o,T.reversed),this._reverse=this._reversed,this._cancelled=0,this._alternate=ze(l,T.alternate),this._prev=null,this._next=null,this._elapsedTime=y,this._startTime=y,this._lastTime=y,this._fps=ze(d,T.frameRate),this._speed=ze(p,T.playbackRate)}get cancelled(){return!!this._cancelled}set cancelled(e){e?this.cancel():this.reset(1).play()}get currentTime(){return Xe(Ne(this._currentTime,lt.precision),-this._delay,this.duration)}set currentTime(e){let t=this.paused;this.pause().seek(+e),t||this.resume()}get iterationCurrentTime(){return Ne(this._iterationTime,lt.precision)}set iterationCurrentTime(e){this.currentTime=this.iterationDuration*this._currentIteration+e}get progress(){return Xe(Ne(this._currentTime/this.duration,10),0,1)}set progress(e){this.currentTime=this.duration*e}get iterationProgress(){return Xe(Ne(this._iterationTime/this.iterationDuration,10),0,1)}set iterationProgress(e){let t=this.iterationDuration;this.currentTime=t*this._currentIteration+t*e}get currentIteration(){return this._currentIteration}set currentIteration(e){this.currentTime=this.iterationDuration*Xe(+e,0,this.iterationCount-1)}get reversed(){return!!this._reversed}set reversed(e){e?this.reverse():this.play()}get speed(){return super.speed}set speed(e){super.speed=e,this.resetTime()}reset(e=0){return Wu(this),this._reversed&&!this._reverse&&(this.reversed=!1),this._iterationTime=this.iterationDuration,_r(this,0,1,e,Kn.FORCE),Km(this),this._hasChildren&&Lt(this,Km),this}init(e=0){this.fps=this._fps,this.speed=this._speed,!e&&this._hasChildren&&_r(this,this.duration,1,e,Kn.FORCE),this.reset(e);let t=this._autoplay;return t===!0?this.resume():t&&!Se(t.linked)&&t.link(this),this}resetTime(){let e=1/(this._speed*sn._speed);return this._startTime=xr()-(this._currentTime+this._delay)*e,this}pause(){return this.paused?this:(this.paused=!0,this.onPause(this),this)}resume(){return this.paused?(this.paused=!1,this.duration<=Tt&&!this._hasChildren?_r(this,Tt,0,0,Kn.FORCE):(this._running||(ls(sn,this),sn._hasChildren=!0,this._running=!0),this.resetTime(),this._startTime-=12,sn.wake()),this):this}restart(){return this.reset(0).resume()}seek(e,t=0,n=0){Wu(this),this.completed=!1;let s=this.paused;return this.paused=!0,_r(this,e+this._delay,~~t,~~n,Kn.AUTO),s?this:this.resume()}alternate(){let e=this._reversed,t=this.iterationCount,n=this.iterationDuration,s=t===1/0?ao(ua/n):t;return this._reversed=+(this._alternate&&!(s%2)?e:!e),t===1/0?this.iterationProgress=this._reversed?1-this.iterationProgress:this.iterationProgress:this.seek(n*s-this._currentTime),this.resetTime(),this}play(){return this._reversed&&this.alternate(),this.resume()}reverse(){return this._reversed||this.alternate(),this.resume()}cancel(){return this._hasChildren?Lt(this,e=>e.cancel(),!0):Lt(this,Zm),this._cancelled=1,this.pause()}stretch(e){let t=this.duration,n=ma(e);if(t===n)return this;let s=e/t,r=e<=Tt;return this.duration=r?Tt:n,this.iterationDuration=r?Tt:ma(this.iterationDuration*s),this._offset*=s,this._delay*=s,this._loopDelay*=s,this}revert(){_r(this,0,1,0,Kn.AUTO);let e=this._autoplay;return e&&e.linked&&e.linked===this&&e.revert(),this.cancel()}complete(){return this.seek(this.duration).cancel()}then(e=rt){let t=this.then,n=()=>{this.then=null,e(this),this.then=t,this._resolve=rt};return new Promise(s=>(this._resolve=()=>s(n()),this.completed&&this._resolve(),this))}},Bn=i=>new Nn(i,null,0).init(),cs=i=>i,Jm=(i,e,t)=>(((1-3*t+3*e)*i+(3*t-6*e))*i+3*e)*i,jS=(i,e,t)=>{let n=0,s=1,r,a,o=0;do a=n+(s-n)/2,r=Jm(a,e,t)-i,r>0?s=a:n=a;while(Ni(r)>1e-7&&++o<100);return a},ZS=(i=.5,e=0,t=.5,n=1)=>i===e&&t===n?cs:s=>s===0||s===1?s:Jm(jS(s,i,t),e,n),KS=(i=10,e)=>{let t=e?DS:ao;return n=>t(Xe(n,0,1)*i)*(1/i)},$m=(...i)=>{let e=i.length;if(!e)return cs;let t=e-1,n=i[0],s=i[t],r=[0],a=[yr(n)];for(let o=1;o<t;o++){let l=i[o],c=Fn(l)?l.trim().split(" "):[l],h=c[0],u=c[1];r.push(Se(u)?o/t:yr(u)/100),a.push(yr(h))}return a.push(yr(s)),r.push(1),function(l){for(let c=1,h=r.length;c<h;c++){let u=r[c];if(l<=u){let d=r[c-1],p=a[c-1];return p+(a[c]-p)*(l-d)/(u-d)}}return a[a.length-1]}},JS=(i=10,e=1)=>{let t=[0],n=i-1;for(let s=1;s<n;s++){let r=t[s-1],a=s/n,o=(s+1)/n,l=a+(o-a)*Math.random(),c=a*(1-e)+l*e;t.push(Xe(c,r,1))}return t.push(1),$m(...t)},$S=pa/2,eg=pa*2,xa=(i=1.68)=>e=>fa(e,+i),tg={[rs]:xa,Quad:xa(2),Cubic:xa(3),Quart:xa(4),Quint:xa(5),Sine:i=>1-Iu(i*$S),Circ:i=>1-Ls(1-i*i),Expo:i=>i?fa(2,10*i-10):0,Bounce:i=>{let e,t=4;for(;i<((e=fa(2,--t))-1)/11;);return 1/fa(4,3-t)-7.5625*fa((e*3-2)/22-i,2)},Back:(i=1.70158)=>e=>(+i+1)*e*e*e-+i*e*e,Elastic:(i=1,e=.3)=>{let t=Xe(+i,1,10),n=Xe(+e,Tt,2),s=n/eg*PS(1/t),r=eg/n;return a=>a===0||a===1?a:-t*fa(2,-10*(1-a))*Pu((1-a-s)*r)}},co={in:i=>e=>i(e),out:i=>e=>1-i(1-e),inOut:i=>e=>e<.5?i(e*2)/2:1-i(e*-2+2)/2,outIn:i=>e=>e<.5?(1-i(1-e*2))/2:(i(e*2-1)+1)/2},ng=(i,e,t)=>{if(t[i])return t[i];if(i.indexOf("(")<=-1){let s=co[i]||i.includes("Back")||i.includes("Elastic")?e[i]():e[i];return s?t[i]=s:cs}else{let n=i.slice(0,-1).split("("),s=e[n[0]];return s?t[i]=s(...n[1].split(",")):cs}},ui=(()=>{let i={linear:$m,irregular:JS,steps:KS,cubicBezier:ZS};for(let e in co)for(let t in tg){let n=tg[t],s=co[e];i[e+t]=t===rs||t==="Back"||t==="Elastic"?(r,a)=>s(n(r,a)):s(n)}return i})(),eb={linear:cs},br=i=>Zt(i)?i:Fn(i)?ng(i,ui,eb):cs,ig={},Xu=(i,e,t)=>{if(t===jt.TRANSFORM){let n=Cu.get(i);return n||i}else if(t===jt.CSS||t===jt.ATTRIBUTE&&Du(e)&&i in e.style){let n=ig[i];if(n)return n;{let s=i&&Um(i);return ig[i]=s,s}}else return i},Yu={deg:1,rad:180/pa,turn:360},sg={},Qu=(i,e,t,n=!1)=>{let s=e.u,r=e.n;if(e.t===St.UNIT&&s===t)return e;let a=r+s+t,o=sg[a];if(!Se(o)&&!n)e.n=o;else{let l;if(s in Yu)l=r*Yu[s]/Yu[t];else{let c=100,h=i.cloneNode(),u=i.parentNode,d=u&&u!==Ve?u:Ve.body;d.appendChild(h);let p=h.style;p.width=c+s;let g=h.offsetWidth||c;p.width=c+t;let v=h.offsetWidth||c,m=g/v;d.removeChild(h),l=m*r}e.n=l,sg[a]=l}return e.t,St.UNIT,e.u=t,e},Mc=i=>{if(i._hasChildren)Lt(i,Mc,!0);else{let e=i;e.pause(),Lt(e,t=>{let n=t.property,s=t.target;if(s[Ac]){let r=s.style,a=e._inlineStyles[n];if(t._tweenType===jt.TRANSFORM){let o=s[io];if(Se(a)||a===rs?delete o[n]:o[n]=a,t._renderTransforms)if(!Object.keys(o).length)r.removeProperty("transform");else{let l=rs;for(let c in o)l+=Ru[c]+o[c]+") ";r.transform=l}}else Se(a)||a===rs?r.removeProperty(n):r[n]=a;e._tail===t&&e.targets.forEach(o=>{o.getAttribute&&o.getAttribute("style")===rs&&o.removeAttribute("style")})}})}return i},ct=Gu(),gt=Gu(),wc={func:null},Cc=[null],ya=[null,null],Rc={to:null},tb=0,Fs,Bi,nb=(i,e)=>{let t={};if(Rn(i)){let n=[].concat(...i.map(s=>Object.keys(s))).filter(da);for(let s=0,r=n.length;s<r;s++){let a=n[s],o=i.map(l=>{let c={};for(let h in l){let u=l[h];da(h)?h===a&&(c.to=u):c[h]=u}return c});t[a]=o}}else{let n=ze(e.duration,lt.defaults.duration);Object.keys(i).map(r=>({o:parseFloat(r)/100,p:i[r]})).sort((r,a)=>r.o-a.o).forEach(r=>{let a=r.o,o=r.p;for(let l in o)if(da(l)){let c=t[l];c||(c=t[l]=[]);let h=a*n,u=c.length,d=c[u-1],p={to:o[l]},g=0;for(let v=0;v<u;v++)g+=c[v].duration;u===1&&(p.from=d.to),o.ease&&(p.ease=o.ease),p.duration=h-(u?g:0),c.push(p)}return r});for(let r in t){let a=t[r],o;for(let l=0,c=a.length;l<c;l++){let h=a[l],u=h.ease;h.ease=o||void 0,o=u}a[0].duration||a.shift()}}return t},Us=class extends Nn{constructor(e,t,n,s,r=!1,a=0,o=0){super(t,n,s);let l=lo(e),c=l.length,h=t.keyframes,u=h?oo(nb(h,t),t):t,{delay:d,duration:p,ease:g,playbackEase:v,modifier:m,composition:f,onRender:x}=u,A=n?n.defaults:lt.defaults,y=ze(v,A.playbackEase),T=y?br(y):null,M=!Se(g)&&!Se(g.ease),C=M?g.ease:ze(g,T?"linear":A.ease),R=M?g.duration:ze(p,A.duration),b=ze(d,A.delay),S=m||A.modifier,D=Se(f)&&c>=Jt?mn.none:Se(f)?A.composition:f,U={},O=this._offset+(n?n._offset:0),N=NaN,V=NaN,B=0,I=0;for(let P=0;P<c;P++){let L=l[P],J=a||P,ae=o||c,ve=NaN,le=NaN;for(let W in u)if(da(W)){let j=Hu(L,W),ie=Xu(W,L,j),ue=u[W],Ie=Rn(ue);if(r&&!Ie&&(ya[0]=ue,ya[1]=ue,ue=ya),Ie){let F=ue.length,Dt=!ln(ue[0]);F===2&&Dt?(Rc.to=ue,Cc[0]=Rc,Fs=Cc):F>2&&Dt?(Fs=[],ue.forEach((Be,qe)=>{qe?qe===1?(ya[1]=Be,Fs.push(ya)):Fs.push(Be):ya[0]=Be})):Fs=ue}else Cc[0]=ue,Fs=Cc;let De=null,He=null,$e=NaN,We=0,Je=0;for(let F=Fs.length;Je<F;Je++){let Dt=Fs[Je];ln(Dt)?Bi=Dt:(Rc.to=Dt,Bi=Rc),wc.func=null;let Be=ei(Bi.to,L,J,ae,wc),qe;ln(Be)&&!Se(Be.to)?(Bi=Be,qe=Be.to):qe=Be;let Le=ei(Bi.from,L,J,ae),pe=Bi.ease,xe=!Se(pe)&&!Se(pe.ease),w=xe?pe.ease:pe||C,_=xe?pe.duration:ei(ze(Bi.duration,F>1?ei(R,L,J,ae)/F:R),L,J,ae),Y=ei(ze(Bi.delay,Je?0:b),L,J,ae),$=ei(ze(Bi.composition,D),L,J,ae),se=Jn($)?$:mn[$],te=Bi.modifier||S,Z=!Se(Le),K=!Se(qe),oe=Rn(qe),Te=oe||Z&&K,re=He?We+Y:Y,ge=O+re;!I&&(Z||oe)&&(I=1);let Fe=He;if(se!==mn.none){De||(De=Vu(L,ie));let Ue=De._head;for(;Ue&&!Ue._isOverridden&&Ue._absoluteStartTime<=ge;)if(Fe=Ue,Ue=Ue._nextRep,Ue&&Ue._absoluteStartTime>=ge)for(;Ue;)Tc(Ue),Ue=Ue._nextRep}if(Te?(hi(oe?ei(qe[0],L,J,ae):Le,ct),hi(oe?ei(qe[1],L,J,ae,wc):qe,gt),ct.t===St.NUMBER&&(Fe?Fe._valueType===St.UNIT&&(ct.t=St.UNIT,ct.u=Fe._unit):(hi(Sr(L,ie,j,U),Un),Un.t===St.UNIT&&(ct.t=St.UNIT,ct.u=Un.u)))):(K?hi(qe,gt):He?qm(He,gt):hi(n&&Fe&&Fe.parent.parent===n?Fe._value:Sr(L,ie,j,U),gt),Z?hi(Le,ct):He?qm(He,ct):hi(n&&Fe&&Fe.parent.parent===n?Fe._value:Sr(L,ie,j,U),ct)),ct.o&&(ct.n=va(Fe?Fe._toNumber:hi(Sr(L,ie,j,U),Un).n,ct.n,ct.o)),gt.o&&(gt.n=va(ct.n,gt.n,gt.o)),ct.t!==gt.t){if(ct.t===St.COMPLEX||gt.t===St.COMPLEX){let Ue=ct.t===St.COMPLEX?ct:gt,Ge=ct.t===St.COMPLEX?gt:ct;Ge.t=St.COMPLEX,Ge.s=Dn(Ue.s),Ge.d=Ue.d.map(()=>Ge.n)}else if(ct.t===St.UNIT||gt.t===St.UNIT){let Ue=ct.t===St.UNIT?ct:gt,Ge=ct.t===St.UNIT?gt:ct;Ge.t=St.UNIT,Ge.u=Ue.u}else if(ct.t===St.COLOR||gt.t===St.COLOR){let Ue=ct.t===St.COLOR?ct:gt,Ge=ct.t===St.COLOR?gt:ct;Ge.t=St.COLOR,Ge.s=Ue.s,Ge.d=[0,0,0,1]}}if(ct.u!==gt.u){let Ue=gt.u?ct:gt;Ue=Qu(L,Ue,gt.u?gt.u:ct.u,!1)}if(gt.d&&ct.d&&gt.d.length!==ct.d.length){let Ue=ct.d.length>gt.d.length?ct:gt,Ge=Ue===ct?gt:ct;Ge.d=Ue.d.map((Pt,z)=>Se(Ge.d[z])?0:Ge.d[z]),Ge.s=Dn(Ue.s)}let Qe=Ne(+_||Tt,12),we={parent:this,id:tb++,property:ie,target:L,_value:null,_func:wc.func,_ease:br(w),_fromNumbers:Dn(ct.d),_toNumbers:Dn(gt.d),_strings:Dn(gt.s),_fromNumber:ct.n,_toNumber:gt.n,_numbers:Dn(ct.d),_number:ct.n,_unit:gt.u,_modifier:te,_currentTime:0,_startTime:re,_delay:+Y,_updateDuration:Qe,_changeDuration:Qe,_absoluteStartTime:ge,_tweenType:j,_valueType:gt.t,_composition:se,_isOverlapped:0,_isOverridden:0,_renderTransforms:0,_prevRep:null,_nextRep:null,_prevAdd:null,_nextAdd:null,_prev:null,_next:null};se!==mn.none&&jm(we,De),isNaN($e)&&($e=we._startTime),We=Ne(re+Qe,12),He=we,B++,ls(this,we)}(isNaN(V)||$e<V)&&(V=$e),(isNaN(N)||We>N)&&(N=We),j===jt.TRANSFORM&&(ve=B-Je,le=B)}if(!isNaN(ve)){let W=0;Lt(this,j=>{W>=ve&&W<le&&(j._renderTransforms=1,j._composition===mn.blend&&Lt(ga.animation,ie=>{ie.id===j.id&&(ie._renderTransforms=1)})),W++})}}c||console.warn("No target found. Make sure the element you're trying to animate is accessible before creating your animation."),V?(Lt(this,P=>{P._startTime-P._delay||(P._delay-=V),P._startTime-=V}),N-=V):V=0,N||(N=Tt,this.iterationCount=0),this.targets=l,this.duration=N===Tt?Tt:Sc((N+this._loopDelay)*this.iterationCount-this._loopDelay)||Tt,this.onRender=x||A.onRender,this._ease=T,this._delay=V,this.iterationDuration=N,this._inlineStyles=U,!this._autoplay&&I&&this.onRender(this)}stretch(e){let t=this.duration;if(t===ma(e))return this;let n=e/t;return Lt(this,s=>{s._updateDuration=ma(s._updateDuration*n),s._changeDuration=ma(s._changeDuration*n),s._currentTime*=n,s._startTime*=n,s._absoluteStartTime*=n}),super.stretch(e)}refresh(){return Lt(this,e=>{let t=e._func;if(t){let n=Sr(e.target,e.property,e._tweenType);hi(n,Un),hi(t(),gt),e._fromNumbers=Dn(Un.d),e._fromNumber=Un.n,e._toNumbers=Dn(gt.d),e._strings=Dn(gt.s),e._toNumber=gt.n}}),this}revert(){return super.revert(),Mc(this)}then(e){return super.then(e)}},Re=(i,e)=>new Us(i,e,null,0,!1).init(),Dc=(i,e=100)=>{let t=[];for(let n=0;n<=e;n++)t.push(i(n/e));return`linear(${t.join(", ")})`},qu={in:"ease-in",out:"ease-out",inOut:"ease-in-out"},ib=(()=>{let i={};for(let e in co)i[e]=t=>co[e](xa(t));return i})(),ju=i=>{let e=qu[i];if(e)return e;if(e="linear",Fn(i)){if(un(i,"linear")||un(i,"cubic-")||un(i,"steps")||un(i,"ease"))e=i;else if(un(i,"cubicB"))e=Um(i);else{let t=ng(i,ib,qu);Zt(t)&&(e=t===cs?"linear":Dc(t))}qu[i]=e}else if(Zt(i)){let t=Dc(i);t&&(e=t)}else i.ease&&(e=Dc(i.ease));return e},rg=["x","y","z"],sb=["perspective","width","height","margin","padding","top","right","bottom","left","borderWidth","fontSize","borderRadius",...rg],rb=(()=>[...rg,...so.filter(i=>["X","Y","Z"].some(e=>i.endsWith(e)))])(),Zu=null,Ku={_head:null,_tail:null},Ju=(i,e,t)=>{let n=Ku._head;for(;n;){let s=n._next,r=n.$el===i,a=!e||n.property===e,o=!t||n.parent===t;if(r&&a&&o){let l=n.animation;try{l.commitStyles()}catch{}l.cancel(),os(Ku,n);let c=n.parent;c&&(c._completed++,c.animations.length===c._completed&&(c.completed=!0,c.muteCallbacks||(c.paused=!0,c.onComplete(c),c._resolve(c))))}n=s}},ag=(i,e,t,n,s)=>{let r=e.animate(n,s),a=s.delay+ +s.duration*s.iterations;r.playbackRate=i._speed,i.paused&&r.pause(),i.duration<a&&(i.duration=a,i.controlAnimation=r),i.animations.push(r),Ju(e,t),ls(Ku,{parent:i,animation:r,$el:e,property:t,_next:null,_prev:null});let o=()=>{Ju(e,t,i)};return r.onremove=o,r.onfinish=o,r},ho=(i,e,t,n,s)=>{let r=ei(e,t,n,s);return Jn(r)?sb.includes(i)||un(i,"translate")?`${r}px`:un(i,"rotate")||un(i,"skew")?`${r}deg`:`${r}`:r},og=(i,e,t,n,s,r)=>{let a="0",o=Se(n)?getComputedStyle(i)[e]:ho(e,n,i,s,r);return Se(t)?a=Rn(n)?n.map(l=>ho(e,l,i,s,r)):o:a=[ho(e,t,i,s,r),o],a},lg=class{constructor(e,t){nn.current&&nn.current.register(this),ro(Zu)&&(Ti&&(Se(CSS)||!Object.hasOwnProperty.call(CSS,"registerProperty"))?Zu=!1:(so.forEach(f=>{let x=un(f,"skew"),A=un(f,"scale"),y=un(f,"rotate"),T=un(f,"translate"),M=y||x,C=M?"<angle>":A?"<number>":T?"<length-percentage>":"*";try{CSS.registerProperty({name:"--"+f,syntax:C,inherits:!1,initialValue:T?"0px":M?"0deg":A?"1":"0"})}catch{}}),Zu=!0));let n=lo(e),s=n.length;s||console.warn("No target found. Make sure the element you're trying to animate is accessible before creating your animation.");let r=ze(t.ease,ju(lt.defaults.ease)),a=r.ease&&r,o=ze(t.autoplay,lt.defaults.autoplay),l=o&&o.link?o:!1,c=t.alternate&&t.alternate===!0,h=t.reversed&&t.reversed===!0,u=ze(t.loop,lt.defaults.loop),d=u===!0||u===1/0?1/0:Jn(u)?u+1:1,p=c?h?"alternate-reverse":"alternate":h?"reverse":"normal",g="forwards",v=ju(r),m=lt.timeScale===1?1:Jt;this.targets=n,this.animations=[],this.controlAnimation=null,this.onComplete=t.onComplete||rt,this.duration=0,this.muteCallbacks=!1,this.completed=!1,this.paused=!o||l!==!1,this.reversed=h,this.autoplay=o,this._speed=ze(t.playbackRate,lt.defaults.playbackRate),this._resolve=rt,this._completed=0,this._inlineStyles=n.map(f=>f.getAttribute("style")),n.forEach((f,x)=>{let A=f[io],y=rb.some(R=>t.hasOwnProperty(R)),T=(a?a.duration:ei(ze(t.duration,lt.defaults.duration),f,x,s))*m,M=ei(ze(t.delay,lt.defaults.delay),f,x,s)*m,C=ze(t.composition,"replace");for(let R in t){if(!da(R))continue;let b={},S={iterations:d,direction:p,fill:g,easing:v,duration:T,delay:M,composite:C},D=t[R],U=y?so.includes(R)?R:Cu.get(R):!1,O;if(ln(D)){let N=D,V=ze(N.ease,r),B=V.ease&&V,I=N.to,P=N.from;if(S.duration=(B?B.duration:ei(ze(N.duration,T),f,x,s))*m,S.delay=ei(ze(N.delay,M),f,x,s)*m,S.composite=ze(N.composition,C),S.easing=ju(V),O=og(f,R,P,I,x,s),U?(b[`--${U}`]=O,A[U]=O):b[R]=og(f,R,P,I,x,s),ag(this,f,R,b,S),!Se(P))if(!U)f.style[R]=b[R][0];else{let L=`--${U}`;f.style.setProperty(L,b[L][0])}}else O=Rn(D)?D.map(N=>ho(R,N,f,x,s)):ho(R,D,f,x,s),U?(b[`--${U}`]=O,A[U]=O):b[R]=O,ag(this,f,R,b,S)}if(y){let R=rs;for(let b in A)R+=`${Ru[b]}var(--${b})) `;f.style.transform=R}}),l&&this.autoplay.link(this)}forEach(e){let t=Fn(e)?n=>n[e]():e;return this.animations.forEach(t),this}get speed(){return this._speed}set speed(e){this._speed=+e,this.forEach(t=>t.playbackRate=e)}get currentTime(){let e=this.controlAnimation,t=lt.timeScale;return this.completed?this.duration:e?+e.currentTime*(t===1?1:t):0}set currentTime(e){let t=e*(lt.timeScale===1?1:Jt);this.forEach(n=>{t>=this.duration&&n.play(),n.currentTime=t})}get progress(){return this.currentTime/this.duration}set progress(e){this.forEach(t=>t.currentTime=e*this.duration||0)}resume(){return this.paused?(this.paused=!1,this.forEach("play")):this}pause(){return this.paused?this:(this.paused=!0,this.forEach("pause"))}alternate(){return this.reversed=!this.reversed,this.forEach("reverse"),this.paused&&this.forEach("pause"),this}play(){return this.reversed&&this.alternate(),this.resume()}reverse(){return this.reversed||this.alternate(),this.resume()}seek(e,t=!1){return t&&(this.muteCallbacks=!0),e<this.duration&&(this.completed=!1),this.currentTime=e,this.muteCallbacks=!1,this.paused&&this.pause(),this}restart(){return this.completed=!1,this.seek(0,!0).resume()}commitStyles(){return this.forEach("commitStyles")}complete(){return this.seek(this.duration)}cancel(){return this.forEach("cancel"),this.pause()}revert(){return this.cancel(),this.targets.forEach((e,t)=>e.setAttribute("style",this._inlineStyles[t])),this}then(e=rt){let t=this.then,n=()=>{this.then=null,e(this),this.then=t,this._resolve=rt};return new Promise(s=>(this._resolve=()=>s(n()),this.completed&&this._resolve(),this))}},cg={animate:(i,e)=>new lg(i,e),convertEase:Dc},hg=(i=rt)=>new Nn({duration:1*lt.timeScale,onComplete:i},null,0).resume();function Ns(i,e,t){let n=lo(i);if(!n.length)return;let[s]=n,r=Hu(s,e),a=Xu(e,s,r),o=Sr(s,a);if(Se(t))return o;if(hi(o,Un),Un.t===St.NUMBER||Un.t===St.UNIT){if(t===!1)return Un.n;{let l=Qu(s,Un,t,!1);return`${Ne(l.n,lt.precision)}${l.u}`}}}var hs=(i,e)=>{if(!Se(e))return e.duration=Tt,e.composition=ze(e.composition,mn.none),new Us(i,e,null,0,!0).resume()},ug=(i,e,t)=>{let n=!1;return Lt(e,s=>{let r=s.target;if(i.includes(r)){let a=s.property,o=s._tweenType,l=Xu(t,r,o);(!l||l&&l===a)&&(s.parent._tail===s&&s._tweenType===jt.TRANSFORM&&s._prev&&s._prev._tweenType===jt.TRANSFORM&&(s._prev._renderTransforms=1),os(e,s),Zm(s),n=!0)}},!0),n},us=(i,e,t)=>{let n=ci(i),s=e||sn,r=e&&e.controlAnimation&&e;for(let o=0,l=n.length;o<l;o++){let c=n[o];Ju(c,t,r)}let a;if(s._hasChildren){let o=0;Lt(s,l=>{if(!l._hasChildren)if(a=ug(n,l,t),a&&!l._head)l.cancel(),os(s,l);else{let h=l._offset+l._delay+l.duration;h>o&&(o=h)}l._head?us(i,l,t):l._hasChildren=!1},!0),Se(s.iterationDuration)||(s.iterationDuration=o)}else a=ug(n,s,t);return a&&!s._head&&(s._hasChildren=!1,s.cancel&&s.cancel()),n},ab=Uu,ob=i=>i[Fu(0,i.length-1)],lb=(i,e)=>(+i).toFixed(e),cb=(i,e,t)=>`${i}`.padStart(e,t),hb=(i,e,t)=>`${i}`.padEnd(e,t),ub=(i,e,t)=>((i-e)%(t-e)+(t-e))%(t-e)+e,uo=(i,e,t,n,s)=>n+(i-e)/(t-e)*(s-n),db=i=>i*pa/180,fb=i=>i*180/pa,dg=(i,e,t,n)=>{let s=Jt/lt.defaults.frameRate;if(n!==!1){let a=n||sn._hasChildren&&sn;a&&a.deltaTime&&(s=a.deltaTime)}let r=1-Math.exp(-t*s*.1);return t?t===1?e:(1-r)*i+r*e:i},pb=(i,e=0)=>(...t)=>e?n=>i(...t,n):n=>i(n,...t),fg=i=>(...e)=>{let t=i(...e);return new Proxy(rt,{apply:(n,s,[r])=>t(r),get:(n,s)=>fg((...r)=>{let a=G[s](...r);return o=>a(t(o))})})},Mi=(i,e=0)=>(...t)=>(t.length<i.length?fg(pb(i,e)):i)(...t),G={$:lo,get:Ns,set:hs,remove:us,cleanInlineStyles:Mc,random:Fu,randomPick:ob,shuffle:Gm,lerp:dg,sync:hg,keepTime:ab,clamp:Mi(Xe),round:Mi(Ne),snap:Mi(Ar),wrap:Mi(ub),interpolate:Mi(as,1),mapRange:Mi(uo),roundPad:Mi(lb),padStart:Mi(cb),padEnd:Mi(hb),degToRad:Mi(db),radToDeg:Mi(fb)},mb=(i,e)=>{if(un(e,"<")){let t=e[1]==="<",n=i._tail,s=n?n._offset+n._delay:0;return t?s:s+n.duration}},Pc=(i,e)=>{let t=i.iterationDuration;if(t===Tt&&(t=0),Se(e))return t;if(Jn(+e))return+e;let n=e,s=i?i.labels:null,r=!ro(s),a=mb(i,n),o=!Se(a),l=Im.exec(n);if(l){let c=l[0],h=n.split(c),u=r&&h[0]?s[h[0]]:t,d=o?a:r?u:t,p=+h[1];return va(d,p,c[0])}else return o?a:r?Se(s[n])?t:s[n]:t};function gb(i){return Sc((i.iterationDuration+i._loopDelay)*i.iterationCount-i._loopDelay)||Tt}function $u(i,e,t,n,s,r){let o=Jn(i.duration)&&i.duration<=Tt?t-Tt:t;_r(e,o,1,1,Kn.AUTO);let l=n?new Us(n,i,e,o,!1,s,r):new Nn(i,e,o);return l.init(1),ls(e,l),Lt(e,c=>{let u=c._offset+c._delay+c.duration;u>e.iterationDuration&&(e.iterationDuration=u)}),e.duration=gb(e),e}var pg=class extends Nn{constructor(e={}){super(e,null,0);this.duration=0,this.labels={};let t=e.defaults,n=lt.defaults;this.defaults=t?oo(t,n):n,this.onRender=e.onRender||n.onRender;let s=ze(e.playbackEase,n.playbackEase);this._ease=s?br(s):null,this.iterationDuration=0}add(e,t,n){let s=ln(t),r=ln(e);if(s||r){if(this._hasChildren=!0,s){let a=t;if(Zt(n)){let o=n,l=ci(e),c=this.duration,h=this.iterationDuration,u=a.id,d=0,p=l.length;l.forEach(g=>{let v={...a};this.duration=c,this.iterationDuration=h,Se(u)||(v.id=u+"-"+d),$u(v,this,o(g,d,p,this),g,d,p),d++})}else $u(a,this,Pc(this,n),e)}else $u(e,this,Pc(this,t));return this.init(1)}}sync(e,t){if(Se(e)||e&&Se(e.pause))return this;e.pause();let n=+(e.effect?e.effect.getTiming().duration:e.duration);return this.add(e,{currentTime:[0,n],duration:n,ease:"linear"},t)}set(e,t,n){return Se(t)?this:(t.duration=Tt,t.composition=mn.replace,this.add(e,t,n))}call(e,t){return Se(e)||e&&!Zt(e)?this:this.add({duration:0,onComplete:()=>e(this)},t)}label(e,t){return Se(e)||e&&!Fn(e)?this:(this.labels[e]=Pc(this,t),this)}remove(e,t){return us(e,this,t),this}stretch(e){let t=this.duration;if(t===ma(e))return this;let n=e/t,s=this.labels;Lt(this,r=>r.stretch(r.duration*n));for(let r in s)s[r]*=n;return super.stretch(e)}refresh(){return Lt(this,e=>{e.refresh&&e.refresh()}),this}revert(){return super.revert(),Lt(this,e=>e.revert,!0),Mc(this)}then(e){return super.then(e)}},Ke=i=>new pg(i).init(),ed=class{constructor(e,t){nn.current&&nn.current.register(this);let n={},s={};if(this.targets=[],this.animations={},!(Se(e)||Se(t))){for(let r in t){let a=t[r];da(r)?s[r]=a:n[r]=a}for(let r in s){let a=s[r],o=ln(a),l={},c="+=0";if(o){let d=a.unit;Fn(d)&&(c+=d)}else l.duration=a;l[r]=o?oo({to:c},a):c;let h=oo(n,l);h.composition=mn.replace,h.autoplay=!1;let u=this.animations[r]=new Us(e,h,null,0,!1).init();this.targets.length||this.targets.push(...u.targets),this[r]=(d,p,g)=>{let v=u._head;if(Se(d)&&v){let m=v._numbers;return m&&m.length?m:v._modifier(v._number)}else return Lt(u,m=>{if(Rn(d))for(let f=0,x=d.length;f<x;f++)Se(m._numbers[f])||(m._fromNumbers[f]=m._modifier(m._numbers[f]),m._toNumbers[f]=d[f]);else m._fromNumber=m._modifier(m._number),m._toNumber=d;Se(g)||(m._ease=br(g)),m._currentTime=0}),Se(p)||u.stretch(p),u.reset(1).resume(),this}}}}revert(){for(let e in this.animations)this[e]=rt,this.animations[e].revert();return this.animations={},this.targets.length=0,this}},fo=(i,e)=>new ed(i,e),mg=class{constructor(e={}){this.timeStep=.02,this.restThreshold=5e-4,this.restDuration=200,this.maxDuration=6e4,this.maxRestSteps=this.restDuration/this.timeStep/Jt,this.maxIterations=this.maxDuration/this.timeStep/Jt,this.m=Xe(ze(e.mass,1),0,Jt),this.s=Xe(ze(e.stiffness,100),1,Jt),this.d=Xe(ze(e.damping,10),.1,Jt),this.v=Xe(ze(e.velocity,0),-1e3,Jt),this.w0=0,this.zeta=0,this.wd=0,this.b=0,this.solverDuration=0,this.duration=0,this.compute(),this.ease=t=>t===0||t===1?t:this.solve(t*this.solverDuration)}solve(e){let{zeta:t,w0:n,wd:s,b:r}=this,a=e;return t<1?a=km(-a*t*n)*(1*Iu(s*a)+r*Pu(s*a)):a=(1+r*a)*km(-a*n),1-a}compute(){let{maxRestSteps:e,maxIterations:t,restThreshold:n,timeStep:s,m:r,d:a,s:o,v:l}=this,c=this.w0=Xe(Ls(o/r),Tt,Jt),h=this.zeta=a/(2*Ls(o*r)),u=this.wd=h<1?c*Ls(1-h*h):0;this.b=h<1?(h*c+-l)/u:-l+c;let d=0,p=0,g=0;for(;p<e&&g<t;)Ni(1-this.solve(d))<n?p++:p=0,this.solverDuration=d,d+=s,g++;this.duration=Ne(this.solverDuration*Jt,0)*lt.timeScale}get mass(){return this.m}set mass(e){this.m=Xe(ze(e,1),0,Jt),this.compute()}get stiffness(){return this.s}set stiffness(e){this.s=Xe(ze(e,100),1,Jt),this.compute()}get damping(){return this.d}set damping(e){this.d=Xe(ze(e,10),.1,Jt),this.compute()}get velocity(){return this.v}set velocity(e){this.v=Xe(ze(e,0),-1e3,Jt),this.compute()}},wi=i=>new mg(i),Bs=i=>{i.cancelable&&i.preventDefault()},gg=class{constructor(e){this.el=e,this.zIndex=0,this.parentElement=null,this.classList={add:rt,remove:rt}}get x(){return this.el.x||0}set x(e){this.el.x=e}get y(){return this.el.y||0}set y(e){this.el.y=e}get width(){return this.el.width||0}set width(e){this.el.width=e}get height(){return this.el.height||0}set height(e){this.el.height=e}getBoundingClientRect(){return{top:this.y,right:this.x,bottom:this.y+this.height,left:this.x+this.width}}},vg=class{constructor(e){this.$el=e,this.inlineTransforms=[],this.point=new DOMPoint,this.inversedMatrix=this.getMatrix().inverse()}normalizePoint(e,t){return this.point.x=e,this.point.y=t,this.point.matrixTransform(this.inversedMatrix)}traverseUp(e){let t=this.$el.parentElement,n=0;for(;t&&t!==Ve;)e(t,n),t=t.parentElement,n++}getMatrix(){let e=new DOMMatrix;return this.traverseUp(t=>{let n=getComputedStyle(t).transform;if(n){let s=new DOMMatrix(n);e.preMultiplySelf(s)}}),e}remove(){this.traverseUp((e,t)=>{this.inlineTransforms[t]=e.style.transform,e.style.transform="none"})}revert(){this.traverseUp((e,t)=>{let n=this.inlineTransforms[t];n===""?e.style.removeProperty("transform"):e.style.transform=n})}},On=(i,e)=>i&&Zt(i)?i(e):i,Ic=0,xg=class{constructor(e,t={}){if(!e)return;nn.current&&nn.current.register(this);let n=t.x,s=t.y,r=t.trigger,a=t.modifier,o=t.releaseEase,l=o&&br(o),c=!Se(o)&&!Se(o.ease),h=ln(n)&&!Se(n.mapTo)?n.mapTo:"translateX",u=ln(s)&&!Se(s.mapTo)?s.mapTo:"translateY",d=On(t.container,this);this.containerArray=Rn(d)?d:null,this.$container=d&&!this.containerArray?ci(d)[0]:Ve.body,this.useWin=this.$container===Ve.body,this.$scrollContainer=this.useWin?Cn:this.$container,this.$target=ln(e)?new gg(e):ci(e)[0],this.$trigger=ci(r||e)[0],this.fixed=Ns(this.$target,"position")==="fixed",this.isFinePointer=!0,this.containerPadding=[0,0,0,0],this.containerFriction=0,this.releaseContainerFriction=0,this.snapX=0,this.snapY=0,this.scrollSpeed=0,this.scrollThreshold=0,this.dragSpeed=0,this.maxVelocity=0,this.minVelocity=0,this.velocityMultiplier=0,this.cursor=!1,this.releaseXSpring=c?o:wi({mass:ze(t.releaseMass,1),stiffness:ze(t.releaseStiffness,80),damping:ze(t.releaseDamping,20)}),this.releaseYSpring=c?o:wi({mass:ze(t.releaseMass,1),stiffness:ze(t.releaseStiffness,80),damping:ze(t.releaseDamping,20)}),this.releaseEase=l||ui.outQuint,this.hasReleaseSpring=c,this.onGrab=t.onGrab||rt,this.onDrag=t.onDrag||rt,this.onRelease=t.onRelease||rt,this.onUpdate=t.onUpdate||rt,this.onSettle=t.onSettle||rt,this.onSnap=t.onSnap||rt,this.onResize=t.onResize||rt,this.onAfterResize=t.onAfterResize||rt,this.disabled=[0,0];let p={};if(a&&(p.modifier=a),Se(n)||n===!0)p[h]=0;else if(ln(n)){let g=n,v={};g.modifier&&(v.modifier=g.modifier),g.composition&&(v.composition=g.composition),p[h]=v}else n===!1&&(p[h]=0,this.disabled[0]=1);if(Se(s)||s===!0)p[u]=0;else if(ln(s)){let g=s,v={};g.modifier&&(v.modifier=g.modifier),g.composition&&(v.composition=g.composition),p[u]=v}else s===!1&&(p[u]=0,this.disabled[1]=1);this.animate=new ed(this.$target,p),this.xProp=h,this.yProp=u,this.destX=0,this.destY=0,this.deltaX=0,this.deltaY=0,this.scroll={x:0,y:0},this.coords=[this.x,this.y,0,0],this.snapped=[0,0],this.pointer=[0,0,0,0,0,0,0,0],this.scrollView=[0,0],this.dragArea=[0,0,0,0],this.containerBounds=[-1e12,ua,ua,-1e12],this.scrollBounds=[0,0,0,0],this.targetBounds=[0,0,0,0],this.window=[0,0],this.velocityStack=[0,0,0],this.velocityStackIndex=0,this.velocityTime=xr(),this.velocity=0,this.angle=0,this.cursorStyles=null,this.triggerStyles=null,this.bodyStyles=null,this.targetStyles=null,this.touchActionStyles=null,this.transforms=new vg(this.$target),this.overshootCoords={x:0,y:0},this.overshootXTicker=new Nn({autoplay:!1},null,0).init(),this.overshootYTicker=new Nn({autoplay:!1},null,0).init(),this.updateTicker=new Nn({autoplay:!1},null,0).init(),this.overshootXTicker.onUpdate=()=>{this.disabled[0]||(this.updated=!0,this.manual=!0,this.animate[this.xProp](this.overshootCoords.x,0))},this.overshootXTicker.onComplete=()=>{this.disabled[0]||(this.manual=!1,this.animate[this.xProp](this.overshootCoords.x,0))},this.overshootYTicker.onUpdate=()=>{this.disabled[1]||(this.updated=!0,this.manual=!0,this.animate[this.yProp](this.overshootCoords.y,0))},this.overshootYTicker.onComplete=()=>{this.disabled[1]||(this.manual=!1,this.animate[this.yProp](this.overshootCoords.y,0))},this.updateTicker.onUpdate=()=>this.update(),this.contained=!Se(d),this.manual=!1,this.grabbed=!1,this.dragged=!1,this.updated=!1,this.released=!1,this.canScroll=!1,this.enabled=!1,this.initialized=!1,this.activeProp=this.disabled[1]?h:u,this.animate.animations[this.activeProp].onRender=()=>{let g=this.updated,m=!(this.grabbed&&g)&&this.released,f=this.x,x=this.y,A=f-this.coords[2],y=x-this.coords[3];this.deltaX=A,this.deltaY=y,this.coords[2]=f,this.coords[3]=x,g&&this.onUpdate(this),m?(this.computeVelocity(A,y),this.angle=_c(y,A)):this.updated=!1},this.animate.animations[this.activeProp].onComplete=()=>{!this.grabbed&&this.released&&(this.released=!1),this.manual||(this.deltaX=0,this.deltaY=0,this.velocity=0,this.velocityStack[0]=0,this.velocityStack[1]=0,this.velocityStack[2]=0,this.velocityStackIndex=0,this.onSettle(this))},this.resizeTicker=new Nn({autoplay:!1,duration:150*lt.timeScale,onComplete:()=>{this.onResize(this),this.refresh(),this.onAfterResize(this)}}).init(),this.parameters=t,this.resizeObserver=new ResizeObserver(()=>{this.initialized?this.resizeTicker.restart():this.initialized=!0}),this.enable(),this.refresh(),this.resizeObserver.observe(this.$container),ln(e)||this.resizeObserver.observe(this.$target)}computeVelocity(e,t){let n=this.velocityTime,s=xr(),r=s-n;if(r<17)return this.velocity;this.velocityTime=s;let a=this.velocityStack,o=this.velocityMultiplier,l=this.minVelocity,c=this.maxVelocity,h=this.velocityStackIndex;a[h]=Ne(Xe(Ls(e*e+t*t)/r*o,l,c),5);let u=zm(a[0],a[1],a[2]);return this.velocity=u,this.velocityStackIndex=(h+1)%3,u}setX(e,t=!1){if(this.disabled[0])return;let n=Ne(e,5);return this.overshootXTicker.pause(),this.manual=!0,this.updated=!t,this.destX=n,this.snapped[0]=Ar(n,this.snapX),this.animate[this.xProp](n,0),this.manual=!1,this}setY(e,t=!1){if(this.disabled[1])return;let n=Ne(e,5);return this.overshootYTicker.pause(),this.manual=!0,this.updated=!t,this.destY=n,this.snapped[1]=Ar(n,this.snapY),this.animate[this.yProp](n,0),this.manual=!1,this}get x(){return Ne(this.animate[this.xProp](),lt.precision)}set x(e){this.setX(e,!1)}get y(){return Ne(this.animate[this.yProp](),lt.precision)}set y(e){this.setY(e,!1)}get progressX(){return uo(this.x,this.containerBounds[3],this.containerBounds[1],0,1)}set progressX(e){this.setX(uo(e,0,1,this.containerBounds[3],this.containerBounds[1]),!1)}get progressY(){return uo(this.y,this.containerBounds[0],this.containerBounds[2],0,1)}set progressY(e){this.setY(uo(e,0,1,this.containerBounds[0],this.containerBounds[2]),!1)}updateScrollCoords(){let e=Ne(this.useWin?Cn.scrollX:this.$container.scrollLeft,0),t=Ne(this.useWin?Cn.scrollY:this.$container.scrollTop,0),[n,s,r,a]=this.containerPadding,o=this.scrollThreshold;this.scroll.x=e,this.scroll.y=t,this.scrollBounds[0]=t-this.targetBounds[0]+n-o,this.scrollBounds[1]=e-this.targetBounds[1]-s+o,this.scrollBounds[2]=t-this.targetBounds[2]-r+o,this.scrollBounds[3]=e-this.targetBounds[3]+a-o}updateBoundingValues(){let e=this.$container,t=this.x,n=this.y,s=this.coords[2],r=this.coords[3];this.coords[2]=0,this.coords[3]=0,this.setX(0,!0),this.setY(0,!0),this.transforms.remove();let a=this.window[0]=Cn.innerWidth,o=this.window[1]=Cn.innerHeight,l=this.useWin,c=e.scrollWidth,h=e.scrollHeight,u=this.fixed,d=e.getBoundingClientRect(),[p,g,v,m]=this.containerPadding;this.dragArea[0]=l?0:d.left,this.dragArea[1]=l?0:d.top,this.scrollView[0]=l?Xe(c,a,c):c,this.scrollView[1]=l?Xe(h,o,h):h,this.updateScrollCoords();let{width:f,height:x,left:A,top:y,right:T,bottom:M}=e.getBoundingClientRect();this.dragArea[2]=Ne(l?Xe(f,a,a):f,0),this.dragArea[3]=Ne(l?Xe(x,o,o):x,0);let C=Ns(e,"overflow"),R=C==="visible",b=C==="hidden";if(this.canScroll=u?!1:this.contained&&(e===Ve.body&&R||!b&&!R)&&(c>this.dragArea[2]+m-g||h>this.dragArea[3]+p-v)&&(!this.containerArray||this.containerArray&&!Rn(this.containerArray)),this.contained){let S=this.scroll.x,D=this.scroll.y,U=this.canScroll,O=this.$target.getBoundingClientRect(),N=U?l?0:e.scrollLeft:0,V=U?l?0:e.scrollTop:0,B=U?this.scrollView[0]-N-f:0,I=U?this.scrollView[1]-V-x:0;this.targetBounds[0]=Ne(O.top+D-(l?0:y),0),this.targetBounds[1]=Ne(O.right+S-(l?a:T),0),this.targetBounds[2]=Ne(O.bottom+D-(l?o:M),0),this.targetBounds[3]=Ne(O.left+S-(l?0:A),0),this.containerArray?(this.containerBounds[0]=this.containerArray[0]+p,this.containerBounds[1]=this.containerArray[1]-g,this.containerBounds[2]=this.containerArray[2]-v,this.containerBounds[3]=this.containerArray[3]+m):(this.containerBounds[0]=-Ne(O.top-(u?Xe(y,0,o):y)+V-p,0),this.containerBounds[1]=-Ne(O.right-(u?Xe(T,0,a):T)-B+g,0),this.containerBounds[2]=-Ne(O.bottom-(u?Xe(M,0,o):M)-I+v,0),this.containerBounds[3]=-Ne(O.left-(u?Xe(A,0,a):A)+N-m,0))}this.transforms.revert(),this.coords[2]=s,this.coords[3]=r,this.setX(t,!0),this.setY(n,!0)}isOutOfBounds(e,t,n){if(!this.contained)return 0;let[s,r,a,o]=e,[l,c]=this.disabled,h=!l&&t<o||!l&&t>r,u=!c&&n<s||!c&&n>a;return h&&!u?1:!h&&u?2:h&&u?3:0}refresh(){let e=this.parameters,t=e.x,n=e.y,s=On(e.container,this),r=On(e.containerPadding,this)||0,a=Rn(r)?r:[r,r,r,r],o=this.x,l=this.y,c=On(e.cursor,this),h={onHover:"grab",onGrab:"grabbing"};if(c){let{onHover:v,onGrab:m}=c;v&&(h.onHover=v),m&&(h.onGrab=m)}this.containerArray=Rn(s)?s:null,this.$container=s&&!this.containerArray?ci(s)[0]:Ve.body,this.useWin=this.$container===Ve.body,this.$scrollContainer=this.useWin?Cn:this.$container,this.isFinePointer=matchMedia("(pointer:fine)").matches,this.containerPadding=ze(a,[0,0,0,0]),this.containerFriction=Xe(ze(On(e.containerFriction,this),.8),0,1),this.releaseContainerFriction=Xe(ze(On(e.releaseContainerFriction,this),this.containerFriction),0,1),this.snapX=On(ln(t)&&!Se(t.snap)?t.snap:e.snap,this),this.snapY=On(ln(n)&&!Se(n.snap)?n.snap:e.snap,this),this.scrollSpeed=ze(On(e.scrollSpeed,this),1.5),this.scrollThreshold=ze(On(e.scrollThreshold,this),20),this.dragSpeed=ze(On(e.dragSpeed,this),1),this.minVelocity=ze(On(e.minVelocity,this),0),this.maxVelocity=ze(On(e.maxVelocity,this),50),this.velocityMultiplier=ze(On(e.velocityMultiplier,this),1),this.cursor=c===!1?!1:h,this.updateBoundingValues();let[u,d,p,g]=this.containerBounds;this.setX(Xe(o,g,d),!0),this.setY(Xe(l,u,p),!0)}update(){if(this.updateScrollCoords(),this.canScroll){let[x,A,y,T]=this.containerPadding,[M,C]=this.scrollView,R=this.dragArea[2],b=this.dragArea[3],S=this.scroll.x,D=this.scroll.y,U=this.$container.scrollWidth,O=this.$container.scrollHeight,N=this.useWin?Xe(U,this.window[0],U):U,V=this.useWin?Xe(O,this.window[1],O):O,B=M-N,I=C-V;this.dragged&&B>0&&(this.coords[0]-=B,this.scrollView[0]=N),this.dragged&&I>0&&(this.coords[1]-=I,this.scrollView[1]=V);let P=this.scrollSpeed*10,L=this.scrollThreshold,[J,ae]=this.coords,[ve,le,W,j]=this.scrollBounds,ie=Ne(Xe((ae-ve+x)/L,-1,0)*P,0),ue=Ne(Xe((J-le-A)/L,0,1)*P,0),Ie=Ne(Xe((ae-W-y)/L,0,1)*P,0),De=Ne(Xe((J-j+T)/L,-1,0)*P,0);if(ie||Ie||De||ue){let[He,$e]=this.disabled,We=S,Je=D;He||(We=Ne(Xe(S+(De||ue),0,M-R),0),this.coords[0]-=S-We),$e||(Je=Ne(Xe(D+(ie||Ie),0,C-b),0),this.coords[1]-=D-Je),this.useWin?this.$scrollContainer.scrollBy(-(S-We),-(D-Je)):this.$scrollContainer.scrollTo(We,Je)}}let[e,t,n,s]=this.containerBounds,[r,a,o,l,c,h]=this.pointer;this.coords[0]+=(r-c)*this.dragSpeed,this.coords[1]+=(a-h)*this.dragSpeed,this.pointer[4]=r,this.pointer[5]=a;let[u,d]=this.coords,[p,g]=this.snapped,v=(1-this.containerFriction)*this.dragSpeed;this.setX(u>t?t+(u-t)*v:u<s?s+(u-s)*v:u,!1),this.setY(d>n?n+(d-n)*v:d<e?e+(d-e)*v:d,!1),this.computeVelocity(r-c,a-h),this.angle=_c(a-l,r-o);let[m,f]=this.snapped;(m!==p&&this.snapX||f!==g&&this.snapY)&&this.onSnap(this)}stop(){this.updateTicker.pause(),this.overshootXTicker.pause(),this.overshootYTicker.pause();for(let e in this.animate.animations)this.animate.animations[e].pause();return us(this,null,"x"),us(this,null,"y"),us(this,null,"progressX"),us(this,null,"progressY"),us(this.scroll),us(this.overshootCoords),this}scrollInView(e,t=0,n=ui.inOutQuad){this.updateScrollCoords();let s=this.destX,r=this.destY,a=this.scroll,o=this.scrollBounds,l=this.canScroll;if(!this.containerArray&&this.isOutOfBounds(o,s,r)){let[c,h,u,d]=o,p=Ne(Xe(r-c,-1e12,0),0),g=Ne(Xe(s-h,0,ua),0),v=Ne(Xe(r-u,0,ua),0),m=Ne(Xe(s-d,-1e12,0),0);new Us(a,{x:Ne(a.x+(m?m-t:g?g+t:0),0),y:Ne(a.y+(p?p-t:v?v+t:0),0),duration:Se(e)?350*lt.timeScale:e,ease:n,onUpdate:()=>{this.canScroll=!1,this.$scrollContainer.scrollTo(a.x,a.y)}}).init().then(()=>{this.canScroll=l})}return this}handleHover(){this.isFinePointer&&this.cursor&&!this.cursorStyles&&(this.cursorStyles=hs(this.$trigger,{cursor:this.cursor.onHover}))}animateInView(e,t=0,n=ui.inOutQuad){this.stop(),this.updateBoundingValues();let s=this.x,r=this.y,[a,o,l,c]=this.containerPadding,h=this.scroll.y-this.targetBounds[0]+a+t,u=this.scroll.x-this.targetBounds[1]-o-t,d=this.scroll.y-this.targetBounds[2]-l-t,p=this.scroll.x-this.targetBounds[3]+c+t,g=this.isOutOfBounds([h,u,d,p],s,r);if(g){let[v,m]=this.disabled,f=Xe(Ar(s,this.snapX),p,u),x=Xe(Ar(r,this.snapY),h,d),A=Se(e)?350*lt.timeScale:e;!v&&(g===1||g===3)&&this.animate[this.xProp](f,A,n),!m&&(g===2||g===3)&&this.animate[this.yProp](x,A,n)}return this}handleDown(e){let t=e.target;if(this.grabbed||t.type==="range")return;e.stopPropagation(),this.grabbed=!0,this.released=!1,this.stop(),this.updateBoundingValues();let n=e.changedTouches,s=n?n[0].clientX:e.clientX,r=n?n[0].clientY:e.clientY,{x:a,y:o}=this.transforms.normalizePoint(s,r),[l,c,h,u]=this.containerBounds,d=(1-this.containerFriction)*this.dragSpeed,p=this.x,g=this.y;this.coords[0]=this.coords[2]=d?p>c?c+(p-c)/d:p<u?u+(p-u)/d:p:p,this.coords[1]=this.coords[3]=d?g>h?h+(g-h)/d:g<l?l+(g-l)/d:g:g,this.pointer[0]=a,this.pointer[1]=o,this.pointer[2]=a,this.pointer[3]=o,this.pointer[4]=a,this.pointer[5]=o,this.pointer[6]=a,this.pointer[7]=o,this.deltaX=0,this.deltaY=0,this.velocity=0,this.velocityStack[0]=0,this.velocityStack[1]=0,this.velocityStack[2]=0,this.velocityStackIndex=0,this.angle=0,this.targetStyles&&(this.targetStyles.revert(),this.targetStyles=null);let v=Ns(this.$target,"zIndex",!1);Ic=(v>Ic?v:Ic)+1,this.targetStyles=hs(this.$target,{zIndex:Ic}),this.triggerStyles&&(this.triggerStyles.revert(),this.triggerStyles=null),this.cursorStyles&&(this.cursorStyles.revert(),this.cursorStyles=null),this.isFinePointer&&this.cursor&&(this.bodyStyles=hs(Ve.body,{cursor:this.cursor.onGrab})),this.scrollInView(100,0,ui.out(3)),this.onGrab(this),Ve.addEventListener("touchmove",this),Ve.addEventListener("touchend",this),Ve.addEventListener("touchcancel",this),Ve.addEventListener("mousemove",this),Ve.addEventListener("mouseup",this),Ve.addEventListener("selectstart",this)}handleMove(e){if(!this.grabbed)return;let t=e.changedTouches,n=t?t[0].clientX:e.clientX,s=t?t[0].clientY:e.clientY,{x:r,y:a}=this.transforms.normalizePoint(n,s),o=r-this.pointer[6],l=a-this.pointer[7],c=e.target,h=!1,u=!1,d=!1;for(;t&&c&&c!==this.$trigger;){let p=Ns(c,"overflow-y");if(p!=="hidden"&&p!=="visible"){let{scrollTop:g,scrollHeight:v,clientHeight:m}=c;if(v>m){d=!0,h=g<=3,u=g>=v-m-3;break}}c=c.parentNode}d&&(!h&&!u||h&&l<0||u&&l>0)?(this.pointer[0]=r,this.pointer[1]=a,this.pointer[2]=r,this.pointer[3]=a,this.pointer[4]=r,this.pointer[5]=a,this.pointer[6]=r,this.pointer[7]=a):(Bs(e),this.triggerStyles||(this.triggerStyles=hs(this.$trigger,{pointerEvents:"none"})),this.$trigger.addEventListener("touchstart",Bs,{passive:!1}),this.$trigger.addEventListener("touchmove",Bs,{passive:!1}),this.$trigger.addEventListener("touchend",Bs),(!this.disabled[0]&&Ni(o)>3||!this.disabled[1]&&Ni(l)>3)&&(this.updateTicker.resume(),this.pointer[2]=this.pointer[0],this.pointer[3]=this.pointer[1],this.pointer[0]=r,this.pointer[1]=a,this.dragged=!0,this.released=!1,this.onDrag(this)))}handleUp(){if(!this.grabbed)return;this.updateTicker.pause(),this.triggerStyles&&(this.triggerStyles.revert(),this.triggerStyles=null),this.bodyStyles&&(this.bodyStyles.revert(),this.bodyStyles=null);let[e,t]=this.disabled,[n,s,r,a,o,l]=this.pointer,[c,h,u,d]=this.containerBounds,[p,g]=this.snapped,v=this.releaseXSpring,m=this.releaseYSpring,f=this.releaseEase,x=this.hasReleaseSpring,A=this.overshootCoords,y=this.x,T=this.y,M=this.computeVelocity(n-o,s-l),C=this.angle=_c(s-a,n-r),R=M*150,b=(1-this.releaseContainerFriction)*this.dragSpeed,S=y+Iu(C)*R,D=T+Pu(C)*R,U=S>h?h+(S-h)*b:S<d?d+(S-d)*b:S,O=D>u?u+(D-u)*b:D<c?c+(D-c)*b:D,N=this.destX=Xe(Ne(Ar(U,this.snapX),5),d,h),V=this.destY=Xe(Ne(Ar(O,this.snapY),5),c,u),B=this.isOutOfBounds(this.containerBounds,S,D),I=0,P=0,L=f,J=f,ae=0;if(A.x=y,A.y=T,!e){let le=N===h?y>h?-1:1:y<d?-1:1,W=Ne(y-N,0);v.velocity=t&&x?W?R*le/Ni(W):0:M;let{ease:j,duration:ie,restDuration:ue}=v;I=y===N?0:x?ie:ie-ue*lt.timeScale,x&&(L=j),I>ae&&(ae=I)}if(!t){let le=V===u?T>u?-1:1:T<c?-1:1,W=Ne(T-V,0);m.velocity=e&&x?W?R*le/Ni(W):0:M;let{ease:j,duration:ie,restDuration:ue}=m;P=T===V?0:x?ie:ie-ue*lt.timeScale,x&&(J=j),P>ae&&(ae=P)}if(!x&&B&&b&&(I||P)){let le=mn.blend;new Us(A,{x:{to:U,duration:I*.65},y:{to:O,duration:P*.65},ease:f,composition:le}).init(),new Us(A,{x:{to:N,duration:I},y:{to:V,duration:P},ease:f,composition:le}).init(),this.overshootXTicker.stretch(I).restart(),this.overshootYTicker.stretch(P).restart()}else e||this.animate[this.xProp](N,I,L),t||this.animate[this.yProp](V,P,J);this.scrollInView(ae,this.scrollThreshold,f);let ve=!1;N!==p&&(this.snapped[0]=N,this.snapX&&(ve=!0)),V!==g&&this.snapY&&(this.snapped[1]=V,this.snapY&&(ve=!0)),ve&&this.onSnap(this),this.grabbed=!1,this.dragged=!1,this.updated=!0,this.released=!0,this.onRelease(this),this.$trigger.removeEventListener("touchstart",Bs),this.$trigger.removeEventListener("touchmove",Bs),this.$trigger.removeEventListener("touchend",Bs),Ve.removeEventListener("touchmove",this),Ve.removeEventListener("touchend",this),Ve.removeEventListener("touchcancel",this),Ve.removeEventListener("mousemove",this),Ve.removeEventListener("mouseup",this),Ve.removeEventListener("selectstart",this)}reset(){return this.stop(),this.resizeTicker.pause(),this.grabbed=!1,this.dragged=!1,this.updated=!1,this.released=!1,this.canScroll=!1,this.setX(0,!0),this.setY(0,!0),this.coords[0]=0,this.coords[1]=0,this.pointer[0]=0,this.pointer[1]=0,this.pointer[2]=0,this.pointer[3]=0,this.pointer[4]=0,this.pointer[5]=0,this.pointer[6]=0,this.pointer[7]=0,this.velocity=0,this.velocityStack[0]=0,this.velocityStack[1]=0,this.velocityStack[2]=0,this.velocityStackIndex=0,this.angle=0,this}enable(){return this.enabled||(this.enabled=!0,this.$target.classList.remove("is-disabled"),this.touchActionStyles=hs(this.$trigger,{touchAction:this.disabled[0]?"pan-x":this.disabled[1]?"pan-y":"none"}),this.$trigger.addEventListener("touchstart",this,{passive:!0}),this.$trigger.addEventListener("mousedown",this,{passive:!0}),this.$trigger.addEventListener("mouseenter",this)),this}disable(){return this.enabled=!1,this.grabbed=!1,this.dragged=!1,this.updated=!1,this.released=!1,this.canScroll=!1,this.touchActionStyles.revert(),this.cursorStyles&&(this.cursorStyles.revert(),this.cursorStyles=null),this.triggerStyles&&(this.triggerStyles.revert(),this.triggerStyles=null),this.bodyStyles&&(this.bodyStyles.revert(),this.bodyStyles=null),this.targetStyles&&(this.targetStyles.revert(),this.targetStyles=null),this.stop(),this.$target.classList.add("is-disabled"),this.$trigger.removeEventListener("touchstart",this),this.$trigger.removeEventListener("mousedown",this),this.$trigger.removeEventListener("mouseenter",this),Ve.removeEventListener("touchmove",this),Ve.removeEventListener("touchend",this),Ve.removeEventListener("touchcancel",this),Ve.removeEventListener("mousemove",this),Ve.removeEventListener("mouseup",this),Ve.removeEventListener("selectstart",this),this}revert(){return this.reset(),this.disable(),this.$target.classList.remove("is-disabled"),this.updateTicker.revert(),this.overshootXTicker.revert(),this.overshootYTicker.revert(),this.resizeTicker.revert(),this.animate.revert(),this}handleEvent(e){switch(e.type){case"mousedown":this.handleDown(e);break;case"touchstart":this.handleDown(e);break;case"mousemove":this.handleMove(e);break;case"touchmove":this.handleMove(e);break;case"mouseup":this.handleUp();break;case"touchend":this.handleUp();break;case"touchcancel":this.handleUp();break;case"mouseenter":this.handleHover();break;case"selectstart":Bs(e);break}}},ds=(i,e)=>new xg(i,e),yg=class{constructor(e={}){nn.current&&nn.current.register(this);let t=e.root,n=Ve;t&&(n=t.current||t.nativeElement||ci(t)[0]||Ve);let s=e.defaults,r=lt.defaults,a=e.mediaQueries;if(this.defaults=s?oo(s,r):r,this.root=n,this.constructors=[],this.revertConstructors=[],this.revertibles=[],this.constructorsOnce=[],this.revertConstructorsOnce=[],this.revertiblesOnce=[],this.once=!1,this.onceIndex=0,this.methods={},this.matches={},this.mediaQueryLists={},this.data={},a)for(let o in a){let l=Cn.matchMedia(a[o]);this.mediaQueryLists[o]=l,l.addEventListener("change",this)}}register(e){(this.once?this.revertiblesOnce:this.revertibles).push(e)}execute(e){let t=nn.current,n=nn.root,s=lt.defaults;nn.current=this,nn.root=this.root,lt.defaults=this.defaults;let r=this.mediaQueryLists;for(let o in r)this.matches[o]=r[o].matches;let a=e(this);return nn.current=t,nn.root=n,lt.defaults=s,a}refresh(){return this.onceIndex=0,this.execute(()=>{let e=this.revertibles.length,t=this.revertConstructors.length;for(;e--;)this.revertibles[e].revert();for(;t--;)this.revertConstructors[t](this);this.revertibles.length=0,this.revertConstructors.length=0,this.constructors.forEach(n=>{let s=n(this);Zt(s)&&this.revertConstructors.push(s)})}),this}add(e,t){if(this.once=!1,Zt(e)){let n=e;this.constructors.push(n),this.execute(()=>{let s=n(this);Zt(s)&&this.revertConstructors.push(s)})}else this.methods[e]=(...n)=>this.execute(()=>t(...n));return this}addOnce(e){if(this.once=!0,Zt(e)){let t=this.onceIndex++;if(this.constructorsOnce[t])return this;let s=e;this.constructorsOnce[t]=s,this.execute(()=>{let r=s(this);Zt(r)&&this.revertConstructorsOnce.push(r)})}return this}keepTime(e){this.once=!0;let t=this.onceIndex++,n=this.constructorsOnce[t];if(Zt(n))return n(this);let s=Uu(e);this.constructorsOnce[t]=s;let r;return this.execute(()=>{r=s(this)}),r}handleEvent(e){switch(e.type){case"change":this.refresh();break}}revert(){let e=this.revertibles,t=this.revertConstructors,n=this.revertiblesOnce,s=this.revertConstructorsOnce,r=this.mediaQueryLists,a=e.length,o=t.length,l=n.length,c=s.length;for(;a--;)e[a].revert();for(;o--;)t[o](this);for(;l--;)n[l].revert();for(;c--;)s[c](this);for(let h in r)r[h].removeEventListener("change",this);e.length=0,t.length=0,this.constructors.length=0,n.length=0,s.length=0,this.constructorsOnce.length=0,this.onceIndex=0,this.matches={},this.methods={},this.mediaQueryLists={},this.data={}}},Os=i=>new yg(i),vb=()=>{let i=document.createElement("div");Ve.body.appendChild(i),i.style.height="100lvh";let e=i.offsetHeight;return Ve.body.removeChild(i),e},Lc=(i,e)=>i&&Zt(i)?i(e):i,td=new Map,Ag=class{constructor(e){this.element=e,this.useWin=this.element===Ve.body,this.winWidth=0,this.winHeight=0,this.width=0,this.height=0,this.left=0,this.top=0,this.zIndex=0,this.scrollX=0,this.scrollY=0,this.prevScrollX=0,this.prevScrollY=0,this.scrollWidth=0,this.scrollHeight=0,this.velocity=0,this.backwardX=!1,this.backwardY=!1,this.scrollTicker=new Nn({autoplay:!1,onBegin:()=>this.dataTimer.resume(),onUpdate:()=>{let t=this.backwardX||this.backwardY;Lt(this,n=>n.handleScroll(),t)},onComplete:()=>this.dataTimer.pause()}).init(),this.dataTimer=new Nn({autoplay:!1,frameRate:30,onUpdate:t=>{let n=t.deltaTime,s=this.prevScrollX,r=this.prevScrollY,a=this.scrollX,o=this.scrollY,l=s-a,c=r-o;this.prevScrollX=a,this.prevScrollY=o,l&&(this.backwardX=s>a),c&&(this.backwardY=r>o),this.velocity=Ne(n>0?Math.sqrt(l*l+c*c)/n:0,5)}}).init(),this.resizeTicker=new Nn({autoplay:!1,duration:250*lt.timeScale,onComplete:()=>{this.updateWindowBounds(),this.refreshScrollObservers(),this.handleScroll()}}).init(),this.wakeTicker=new Nn({autoplay:!1,duration:500*lt.timeScale,onBegin:()=>{this.scrollTicker.resume()},onComplete:()=>{this.scrollTicker.pause()}}).init(),this._head=null,this._tail=null,this.updateScrollCoords(),this.updateWindowBounds(),this.updateBounds(),this.refreshScrollObservers(),this.handleScroll(),this.resizeObserver=new ResizeObserver(()=>this.resizeTicker.restart()),this.resizeObserver.observe(this.element),(this.useWin?Cn:this.element).addEventListener("scroll",this,!1)}updateScrollCoords(){let e=this.useWin,t=this.element;this.scrollX=Ne(e?Cn.scrollX:t.scrollLeft,0),this.scrollY=Ne(e?Cn.scrollY:t.scrollTop,0)}updateWindowBounds(){this.winWidth=Cn.innerWidth,this.winHeight=vb()}updateBounds(){let e=getComputedStyle(this.element),t=this.element;this.scrollWidth=t.scrollWidth+parseFloat(e.marginLeft)+parseFloat(e.marginRight),this.scrollHeight=t.scrollHeight+parseFloat(e.marginTop)+parseFloat(e.marginBottom),this.updateWindowBounds();let n,s;if(this.useWin)n=this.winWidth,s=this.winHeight;else{let r=t.getBoundingClientRect();n=r.width,s=r.height,this.top=r.top,this.left=r.left}this.width=n,this.height=s}refreshScrollObservers(){Lt(this,e=>{e._debug&&e.removeDebug()}),this.updateBounds(),Lt(this,e=>{e.refresh(),e._debug&&e.debug()})}refresh(){this.updateWindowBounds(),this.updateBounds(),this.refreshScrollObservers(),this.handleScroll()}handleScroll(){this.updateScrollCoords(),this.wakeTicker.restart()}handleEvent(e){switch(e.type){case"scroll":this.handleScroll();break}}revert(){this.scrollTicker.cancel(),this.dataTimer.cancel(),this.resizeTicker.cancel(),this.wakeTicker.cancel(),this.resizeObserver.unobserve(this.element),(this.useWin?Cn:this.element).removeEventListener("scroll",this),td.delete(this.element)}},xb=i=>{let e=i&&ci(i)[0]||Ve.body,t=td.get(e);return t||(t=new Ag(e),td.set(e,t)),t},po=(i,e,t,n,s)=>{let r=e==="min",a=e==="max",o=e==="top"||e==="left"||e==="start"||r?0:e==="bottom"||e==="right"||e==="end"||a?"100%":e==="center"?"50%":e,{n:l,u:c}=hi(o,Un),h=l;return c==="%"?h=l/100*t:c&&(h=Qu(i,Un,"px",!0).n),a&&n<0&&(h+=n),r&&s>0&&(h+=s),h},Fc=(i,e,t,n,s)=>{let r;if(Fn(e)){let a=Im.exec(e);if(a){let o=a[0],l=o[0],c=e.split(o),h=c[0]==="min",u=c[0]==="max",d=po(i,c[0],t,n,s),p=po(i,c[1],t,n,s);if(h){let g=va(po(i,"min",t),p,l);r=g<d?d:g}else if(u){let g=va(po(i,"max",t),p,l);r=g>d?d:g}else r=va(d,p,l)}else r=po(i,e,t,n,s)}else r=e;return Ne(r,0)},_g=i=>{let e,t=i.targets;for(let n=0,s=t.length;n<s;n++){let r=t[n];if(r[Ac]){e=r;break}}return e},yb=0,Sg=["#FF4B4B","#FF971B","#FFC730","#F9F640","#7AFF5A","#18FF74","#17E09B","#3CFFEC","#05DBE9","#33B3F1","#638CF9","#C563FE","#FF4FCF","#F93F8A"],bg=class{constructor(e={}){nn.current&&nn.current.register(this);let t=ze(e.sync,"play pause"),n=t?br(t):null,s=t&&(t==="linear"||t===cs),r=t&&!(n===cs&&!s),a=t&&(Jn(t)||t===!0||s),o=t&&Fn(t)&&!r&&!a,l=o?t.split(" ").map(h=>()=>{let u=this.linked;return u&&u[h]?u[h]():null}):null,c=o&&l.length>2;this.index=yb++,this.id=Se(e.id)?this.index:e.id,this.container=xb(e.container),this.target=null,this.linked=null,this.repeat=null,this.horizontal=null,this.enter=null,this.leave=null,this.sync=r||a||!!l,this.syncEase=r?n:null,this.syncSmooth=a?t===!0||s?1:t:null,this.onSyncEnter=l&&!c&&l[0]?l[0]:rt,this.onSyncLeave=l&&!c&&l[1]?l[1]:rt,this.onSyncEnterForward=l&&c&&l[0]?l[0]:rt,this.onSyncLeaveForward=l&&c&&l[1]?l[1]:rt,this.onSyncEnterBackward=l&&c&&l[2]?l[2]:rt,this.onSyncLeaveBackward=l&&c&&l[3]?l[3]:rt,this.onEnter=e.onEnter||rt,this.onLeave=e.onLeave||rt,this.onEnterForward=e.onEnterForward||rt,this.onLeaveForward=e.onLeaveForward||rt,this.onEnterBackward=e.onEnterBackward||rt,this.onLeaveBackward=e.onLeaveBackward||rt,this.onUpdate=e.onUpdate||rt,this.onSyncComplete=e.onSyncComplete||rt,this.reverted=!1,this.completed=!1,this.began=!1,this.isInView=!1,this.forceEnter=!1,this.hasEntered=!1,this.offsets=[],this.offset=0,this.offsetStart=0,this.offsetEnd=0,this.distance=0,this.prevProgress=0,this.thresholds=["start","end","end","start"],this.coords=[0,0,0,0],this.debugStyles=null,this.$debug=null,this._params=e,this._debug=ze(e.debug,!1),this._next=null,this._prev=null,ls(this.container,this),hg(()=>{if(!this.reverted){if(!this.target){let h=ci(e.target)[0];this.target=h||Ve.body,this.refresh()}this._debug&&this.debug()}})}link(e){if(e&&(e.pause(),this.linked=e,!this._params.target)){let t;Se(e.targets)?Lt(e,n=>{n.targets&&!t&&(t=_g(n))}):t=_g(e),this.target=t||Ve.body,this.refresh()}return this}get velocity(){return this.container.velocity}get backward(){return this.horizontal?this.container.backwardX:this.container.backwardY}get scroll(){return this.horizontal?this.container.scrollX:this.container.scrollY}get progress(){let e=(this.scroll-this.offsetStart)/this.distance;return e===1/0||isNaN(e)?0:Ne(Xe(e,0,1),6)}refresh(){this.reverted=!1;let e=this._params;return this.repeat=ze(Lc(e.repeat,this),!0),this.horizontal=ze(Lc(e.axis,this),"y")==="x",this.enter=ze(Lc(e.enter,this),"end start"),this.leave=ze(Lc(e.leave,this),"start end"),this.updateBounds(),this.handleScroll(),this}removeDebug(){return this.$debug&&(this.$debug.parentNode.removeChild(this.$debug),this.$debug=null),this.debugStyles&&(this.debugStyles.revert(),this.$debug=null),this}debug(){this.removeDebug();let e=this.container,t=this.horizontal,n=e.element.querySelector(":scope > .animejs-onscroll-debug"),s=Ve.createElement("div"),r=Ve.createElement("div"),a=Ve.createElement("div"),o=Sg[this.index%Sg.length],l=e.useWin,c=l?e.winWidth:e.width,h=l?e.winHeight:e.height,u=e.scrollWidth,d=e.scrollHeight,p=this.container.width>360?320:260,g=t?0:10,v=t?10:0,m=t?24:p/2,f=t?m:15,x=t?60:m,A=t?x:f,y=t?"repeat-x":"repeat-y",T=S=>t?"0px "+S+"px":S+"px 2px",M=S=>`linear-gradient(${t?90:0}deg, ${S} 2px, transparent 1px)`,C=(S,D,U,O,N)=>`position:${S};left:${D}px;top:${U}px;width:${O}px;height:${N}px;`;s.style.cssText=`${C("absolute",g,v,t?u:p,t?p:d)}
      pointer-events: none;
    ...
    `,r.style.cssText=`${C("sticky",0,0,t?c:m,t?m:h)}`,n||(r.style.cssText+=`background:
      ...
      `);let R=[" enter: "," leave: "];this.coords.forEach((S,D)=>{let U=D>1,O=(U?0:this.offset)+S,N=D%2,V=O<A,B=O>(U?t?c:h:t?u:d)-A,I=(U?N&&!V:!N&&!V)||B,P=Ve.createElement("div"),L=Ve.createElement("div"),J=t?I?"right":"left":I?"bottom":"top",ae=I?(t?x:f)+(U?t?-1:B?0:-2:t?-1:-2):t?1:0;L.innerHTML=`${this.id}${R[N]}${this.thresholds[D]}`,P.style.cssText=`${C("absolute",0,0,x,f)}
        display: flex;
        flex-direction: ${t?"column":"row"};
      ...
      `,L.style.cssText=`
        ...
        color: ${N?o:"rgba(0,0,0,.75)"};
        background-color: ${N?"rgba(0,0,0,.65)":o};
        border: 2px solid ${N?o:"transparent"};
...
`;for(let A of s.matchAll(/(?:varying\s+\w+\s+([\S\s]*?);)/g))for(let y of A[1].split(/\s*,\s*/))t.varyings.add(y),g.add(y),v.add(y);for(let A of s.matchAll(o))v.add(A[1])}for(let x of n.matchAll(o))v.add(x[1]);for(let x of e.defines.keys())v.add(x.replace(/\([\w\s,]*\)/g,""));for(let x of e.uniforms.keys())v.add(x);v.delete("while"),v.delete("for"),v.delete("if"),e.uniforms.forEach((x,A)=>t.uniforms.set(i+A.charAt(0).toUpperCase()+A.slice(1),x)),e.defines.forEach((x,A)=>t.defines.set(i+A.charAt(0).toUpperCase()+A.slice(1),x));let m=new Map([["fragment",n],["vertex",s]]);$g(i,v,t.defines),$g(i,v,m),n=m.get("fragment"),s=m.get("vertex");let f=e.blendMode;if(t.blendModes.set(f.blendFunction,f),r){e.inputColorSpace!==null&&e.inputColorSpace!==t.colorSpace&&(u+=e.inputColorSpace===nt?`color0 = sRGBTransferOETF(color0);
	...
	`),e.outputColorSpace!==Wn?t.colorSpace=e.outputColorSpace:e.inputColorSpace!==null&&(t.colorSpace=e.inputColorSpace);let x=/MainImage *\([\w\s,]*?depth[\w\s,]*?\)/;u+=`${i}MainImage(color0, UV, `,(t.attributes&ks.DEPTH)!=0&&x.test(n)&&(u+="depth, ",t.readDepth=!0),u+=`color1);
...
`}if(c+=n+`
`,s!==null&&(d+=s+`
`),l.set(Ct.FRAGMENT_HEAD,c),l.set(Ct.FRAGMENT_MAIN_UV,h),l.set(Ct.FRAGMENT_MAIN_IMAGE,u),l.set(Ct.VERTEX_HEAD,d),l.set(Ct.VERTEX_MAIN_SUPPORT,p),e.extensions!==null)for(let x of e.extensions)t.extensions.add(x)}}var e0=class extends di{constructor(i,...e){super("EffectPass");this.fullscreenMaterial=new VE(null,null,null,i),this.listener=t=>this.handleEvent(t),this.effects=[],this.setEffects(e),this.skipRendering=!1,this.minTime=1,this.maxTime=Number.POSITIVE_INFINITY,this.timeScale=1}set mainScene(i){for(let e of this.effects)e.mainScene=i}set mainCamera(i){this.fullscreenMaterial.copyCameraSettings(i);for(let e of this.effects)e.mainCamera=i}get encodeOutput(){return this.fullscreenMaterial.encodeOutput}set encodeOutput(i){this.fullscreenMaterial.encodeOutput=i}get dithering(){return this.fullscreenMaterial.dithering}set dithering(i){let e=this.fullscreenMaterial;e.dithering=i,e.needsUpdate=!0}setEffects(i){for(let e of this.effects)e.removeEventListener("change",this.listener);this.effects=i.sort((e,t)=>t.attributes-e.attributes);for(let e of this.effects)e.addEventListener("change",this.listener)}updateMaterial(){let i=new Gb,e=0;for(let a of this.effects)if(a.blendMode.blendFunction===At.DST)i.attributes|=a.getAttributes()&ks.DEPTH;else{if((i.attributes&a.getAttributes()&ks.CONVOLUTION)!=0)throw new Error(`Convolution effects cannot be merged (${a.name})`);WE("e"+e++,a,i)}let t=i.shaderParts.get(Ct.FRAGMENT_HEAD),n=i.shaderParts.get(Ct.FRAGMENT_MAIN_IMAGE),s=i.shaderParts.get(Ct.FRAGMENT_MAIN_UV),r=/\bblend\b/g;for(let a of i.blendModes.values())t+=a.getShaderCode().replace(r,`blend${a.blendFunction}`)+`
`;(i.attributes&ks.DEPTH)!=0?(i.readDepth&&(n=`float depth = readDepth(UV);
